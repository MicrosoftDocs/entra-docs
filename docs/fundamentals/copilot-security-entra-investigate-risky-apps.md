...
title: Investigate app risk in Microsoft Copilot for Security
description: Use Microsoft Copilot for Security and Microsoft Entra skills to quickly investigate potential risky applications.
keywords:
author: rwike77
ms.author: ryanwi
manager: celestedg
...
# Customer intent: As a SOC analyst or IT admin, I want to learn how to use the Microsoft Entra skills in Microsoft Copilot for Security so that I can proactively identify potential app risks.
---
