...
1. Enter a **Group name.** Choose a name that you'll remember and that makes sense for the group. A check will be performed to determine whether the name is already in use. If the name is already in use, you'll be asked to change the name of your group.
...
1. Select the box next to a name from the list and select the **Remove** button.
