...
|[Upcoming changes to device identity key storage for Apple SSO](../identity-platform/apple-sso-plugin.md#upcoming-changes-to-device-identity)|Feature change|Q3 2026|
