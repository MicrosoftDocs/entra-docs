...
|[Upcoming changes to device identity key storage for Apple SSO](../identity-platform/apple-sso-plugin#upcoming-changes-to-device-identity.md)|Feature change|Q3 2026|
