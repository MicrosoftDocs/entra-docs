...
#Customer Intent: As an IT admin, I want to manage access to custom security attributes so that I can control who can assign and read custom attribute values.
---
