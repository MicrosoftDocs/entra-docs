...
> [!NOTE]
> For non-interactive sign ins that require MFA, there is a change that this will now require MFA to be fulfilled before proceeding. This change will be active on all tenants created after December 28th, 2023 and all other impacted tenants will be contacted when we roll out the change for their tenant.
