...
- [Tenants](#tenants): Get quick access to your Entra ID organization information, including tenant ID, display name, active licenses, and contacts.
...
This feature is available using a free Microsoft Entra ID license, or a Microsoft Entra ID P1 or P2 license. It is also available in Microsoft Entra Workload ID. 
...
External Health Monitoring is a feature in Microsoft Entra that analyzes scenario-specific metrics for each tenant, detects anomalies, and raises alerts. These alerts are sent via the Microsoft Graph API and displayed in the Entra Admin Center UI, enabling tenant admins to proactively investigate and address issues. 

For example, in the Multi-Factor Authentication (MFA) scenario, External Health Monitoring tracks metrics such as sign-in success rate, sign-in failure rate, and failure count. If there is a spike in failures, an alert is raised to notify the tenant admin, who can then take appropriate action to resolve the issue. 
...
> [!NOTE]
> 
> Details of this feature have not been provided yet. This section will be updated with more information, methods, and examples before GA.

### Domains

Microsoft Entra leverages the capabilities of Security Copilot to simplify domain management in the Entra Admin Center.  
...
Managing license purchases and usage across your Microsoft Entra tenant can be challenging. Microsoft Security Copilot simplifies this process by allowing administrators to ask natural language questions about license usage, such as “How many Entra P2 licenses are in use?” or “How many users are using Conditional Access?” Security Copilot provides clear, actionable answers in seconds, helping your organization optimize license utilization and get the most value from your Entra investment.
...
- *How many Entra P1 licenses do I have?*
- *Count of P1 Entra licenses*
- *Number of Microsoft Entra ID P1 licenses*
- *What is the usage of Entra P1 license?*
- *Show me P1 feature utilization*
- *Entra P1 license usage details*
- *How many Entra P2 licenses do I have?*
- *Count of P2 Entra licenses*
- *Number of Microsoft Entra ID P2 licenses*
- *What is the usage of Entra P2 Premium license?*
- *Show me P2 feature utilization*
- *Entra P2 license usage details*
