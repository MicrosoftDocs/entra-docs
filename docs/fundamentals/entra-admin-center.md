...
![Microsoft Entra admin center overview](./media/entra-admin-center/entra-admin-center-overview.png)
...
![Microsoft Entra admin center What's new](./media/entra-admin-center/entra-admin-whats-new.png)
...
![Microsoft Entra admin center Identity menu](./media/entra-admin-center/entra-admin-identity.png)
...
![Microsoft Entra admin center Protection menu](./media/entra-admin-center/entra-admin-protection.png)
...
![Microsoft Entra admin center Identity governance menu](./media/entra-admin-center/entra-admin-identity-governance.png)
...
![Microsoft Entra admin center Verified ID menu](./media/entra-admin-center/entra-admin-verified-id.png)
...
![Microsoft Entra admin center Permissions Management menu](./media/entra-admin-center/entra-admin-permissions-management.png)
...
![Microsoft Entra admin center Diagnose & solve menu](./media/entra-admin-center/entra-admin-diagnose-and-solve.png)

![Microsoft Entra admin center Learn & support menu](./media/entra-admin-center/entra-admin-learn-and-support.png)
