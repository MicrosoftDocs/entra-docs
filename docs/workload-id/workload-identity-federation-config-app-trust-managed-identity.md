...
This example shows how to use Bicep to create a FIC to make your app trust the assigned managed identity. Replace the placeholders with the appropriate values. Note the [Microsoft Graph Bicep feature limitations](/graph/templates/limitations#unsupported-deployment-features) that affect this sample.
