...
[!INCLUDE [active-directory-b2c-create-self-signed-certificate](~/../entra-docs-pr/docs/includes/azure-docs-pr/active-directory-b2c-create-self-signed-certificate.md)]
