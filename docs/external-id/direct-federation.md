...
- On the **New SAML/WS-Fed IdP** page, select **Domainless**. Selecting **Domainless** enforces no domain check of the user's email address.
    ...
    :::image type="content" source="media/direct-federation/new-saml-wsfed-identity-provider-domainless.png" alt-text="Screenshot showing the SAML/WS-Fed identity provider list with the domainless configuration." lightbox="media/direct-federation/new-saml-wsfed-identity-provider-domainless.png":::
