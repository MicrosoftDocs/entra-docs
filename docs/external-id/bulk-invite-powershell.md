...
:::image type="content" source="media/tutorial-bulk-invite/B2BBulkImport.png" alt-text="Screenshot that shows PowerShell output that includes pending user acceptance.":::
