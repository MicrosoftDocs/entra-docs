...
## Linking your tenant to a subscription

Microsoft Entra tenants, both workforce and external, must be linked to an Azure subscription for proper billing and access to features. To link your tenant to a subscription, follow these steps.
