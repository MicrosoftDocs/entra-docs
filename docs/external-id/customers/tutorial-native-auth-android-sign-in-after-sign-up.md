...
:::image type="content" source="media/native-auth/android/android-sign-in-after-sign-up-flow.png" alt-text="A mock-up image illustrates how to sign in user after sign up":::
