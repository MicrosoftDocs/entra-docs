...
We recommend that you protect all administrator accounts with multifactor authentication (MFA). MFA is an identity verification process during sign-in that prompts the user for a one-time passcode.
