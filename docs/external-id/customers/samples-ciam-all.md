...
> | ------- | -------- | ------------- |
> | JavaScript, Angular, React | &#8226; [Sign in users](../../identity-platform/quickstart-single-page-app-sign-in.md) | &#8226; [Sign in users](../../identity-platform/tutorial-single-page-app-vanillajs-prepare-app.md) |
...
> | App type | Code sample guide | Build and integrate guide  |
> | ------- | -------- | ------------- |
> | Single-page application | &#8226; [Sign in users](../../identity-platform/quickstart-single-page-app-sign-in.)md | &#8226; [Sign in users](../../identity-platform/tutorial-single-page-app-vanillajs-prepare-app.md) |
