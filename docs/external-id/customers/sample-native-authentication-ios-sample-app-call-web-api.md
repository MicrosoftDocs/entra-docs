...
You need to host your web API for the iOS sample app to call it. Follow [Quickstart: Deploy an ASP.NET web app](/app-service/quickstart-dotnetcore) to deploy your your web API.
