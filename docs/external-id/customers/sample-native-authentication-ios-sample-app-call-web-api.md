...
The samples enable you to configure multiple Web API URL endpoints and sets of scopes. For this case, you will configure just one Web API URL endpoint and its associated scopes.
