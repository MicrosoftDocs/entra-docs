...
1. Find property named `scopes` and set the scopes recorded in [Add permissions to access your web API](#add-permissions-to-access-your-web-api).
    ...
    ```kotlin
    private val scopes = listOf<String>() // Developers should set the respective scopes of their web API here e.g. private val scopes = listOf<String>("api://{clientId}/{ToDoList.Read}", "api://{clientId}/{ToDoList.ReadWrite}")
    ```
