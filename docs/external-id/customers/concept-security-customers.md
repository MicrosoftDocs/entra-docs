...
| **Enhanced monitoring and alerting** | Use [Azure Monitor and Microsoft Sentinel](/entra/external-id/customers/how-to-azure-monitor) to enable one-click monitoring, log analytics, and advanced threat detection.  |Medium – Early threat detection | None – Backend only |High – Azure Monitor integration | Azure Monitor costs |

### Priority 3: Long-term implementation (3–12 Months)

| **Security feature** |**Description** |**Threat prevention** | **User impact** | **Implementation cost** | **Licensing** |
|----|----|----|----|----|
| **Monitoring and alerting** |Fine-tune monitoring and alert thresholds to improve accuracy. |Medium - Accurate monitoring |None – Backend only| Medium – Policy design | Azure Monitor costs |
| **Continuous security enhancements and new features** |Use the 3–12 month period to iterate on your security controls and adopt [new enhancements](/entra/external-id/whats-new-docs?tabs=external-tenants). |Medium - Updated features |Depends on the new feature | Medium – Policy design | Various costs |
| **[Zero Trust Assessment](/security/zero-trust/assessment/overview)** |Tests hundreds of security settings based on Secure Future Initiative (SFI) and Zero Trust principles. |High - Thorough security configuration testing |None – Backend only |Medium – Policy design | Free (First 50K MAU) |
...
| **[ID Protection](/entra/id-protection/overview-identity-protection)** | ID Protection tenant risk detection isn’t supported in external tenants. | Use [Azure Monitor and Microsoft Sentinel integration](/entra/external-id/customers/how-to-azure-monitor) instead. |
