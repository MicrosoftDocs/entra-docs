...
Learn how to support web fallback in [native Android apps](tutorial-native-authentication-android-support-web-fallback.md) and [native iOS/macOS apps](tutorial-native-authentication-ios-support-web-fallback.md).
...
- [Tutorial: Support web fallback in iOS/macOS app](tutorial-native-authentication-ios-support-web-fallback.md)