...
| **Custom domain names** |  You can use [custom domains](~/fundamentals/add-custom-domain.yml) for administrative accounts only. | [Custom URL domains (preview)](concept-custom-url-domain.md) in external tenants let you brand your app's sign-in endpoints with your own domain name.|
