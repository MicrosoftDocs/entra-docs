...
Feature  |Workforce tenant  | External tenant |
|---------|---------|---------|
| **Application gallery**         | The [app gallery](/entra/identity/enterprise-apps/overview-application-gallery) contains thousands of applications that are preintegrated into Microsoft Entra ID.   | The Microsoft Entra application gallery catalog is not available. To find apps, use the search bar instead.    |
