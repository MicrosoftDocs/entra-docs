...
| **Custom banned passwords**| [Custom banned passwords ](../../identity/authentication/tutorial-configure-custom-password-protection.md) lets you add specific strings to evaluate and block during password creation and reset.| Same as workforce. |
