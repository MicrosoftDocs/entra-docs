...
The authority is a URL that indicates a directory that MSAL can request tokens from. For customer-facing applications, alway use the following format: *&lt;tenant-name&gt;.ciamlogin.com*
