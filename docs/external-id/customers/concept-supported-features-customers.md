...
| [Passkey (FIDO2)](./how-to-sign-in-with-passkey.md) | :::image type="icon" source="../media/common/applies-to-yes.png" border="false":::  |  |  | :::image type="icon" source="../media/common/applies-to-yes.png" border="false":::  |
