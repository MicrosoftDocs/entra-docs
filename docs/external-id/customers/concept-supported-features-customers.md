...
| **Local accounts** | Local accounts are supported for *internal* members of your organization only. <br></br>External users have guest accounts in your workforce directory.   | Local accounts are supported for external users (consumers, business customers). <br></br>Guest invitations and guest accounts are also supported. |
