...
| **Identity providers** | Self-service sign-up for guest accounts:</br>- Microsoft Entra accounts</br>- Microsoft accounts</br>- Email one-time passcode</br>- Google federation</br>- Facebook federation<br></br>Guest invitations:</br>- Microsoft Entra accounts</br>- Microsoft accounts</br>- Email one-time passcode</br>- Google federation</br>- SAML/WS-Fed federation | Self-service sign-up for external users (consumers, business customers):</br>- Email and password</br>- Email and one-time passcode</br>- [Google federation](./how-to-google-federation-customers.md)</br>- [Facebook federation](./how-to-facebook-federation-customers.md)<br></br>Invitations:</br>- Same as workforce |
