...
| **Identity providers** | Guest invitations and guest self-service sign-up:<br></br>- Microsoft Entra accounts </br>- Microsoft accounts </br>- Google federation</br>- Facebook federation</br>- SAML/WS-Fed federation | User self-service sign-up:<br></br>- [Google federation](./how-to-google-federation-customers.md)</br>- [Facebook federation](./how-to-facebook-federation-customers.md)|
