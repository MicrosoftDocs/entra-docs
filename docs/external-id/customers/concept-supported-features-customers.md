...
|**Session**|[Session controls](~/identity/conditional-access/concept-conditional-access-session.md)|The following session controls are available:<li> Sign-in frequency </li><li> Persistent browser session </li>|
