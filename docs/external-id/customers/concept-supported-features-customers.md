...
| **Custom banned passwords**| The Microsoft Entra custom banned password list lets you add specific strings to evaluate and block. For more information,see [Configure custom banned passwords for Microsoft Entra password protection](../../identity/authentication/tutorial-configure-custom-password-protection.md) | Same as workforce. |
