...
| **Identity providers** | Guest invitations and guest self-service sign-up:</br>- Microsoft Entra accounts </br>- Microsoft accounts </br>- Google federation</br>- Facebook federation</br>- SAML/WS-Fed federation | Self-service sign-up:</br>- [Google federation](./how-to-google-federation-customers.md)</br>- [Facebook federation](./how-to-facebook-federation-customers.md)|
