...
Construct the authorization URL that is used to prompt the administrator to grant delegated permissions. The role parameter is used to specify the requested application permissions.
