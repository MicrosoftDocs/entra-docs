...
:::image type="content" source="media/agentic-oauth-protocols/agent-flows.png" alt-text="Diagram showing the illustration of oauth flow for agents." lightbox="media/agentic-oauth-protocols/agent-flows.png":::
 
- [Agent on-behalf of flow](./agent-on-behalf-of-oauth-flow.md): Agents operating on behalf of regular users (interactive agents).
- [Autonomous app flow](./agent-autonomous-app-oauth-flow.md): App-only operations enable agent IDs to act autonomously without user context.
