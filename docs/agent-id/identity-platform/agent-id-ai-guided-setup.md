...
6. **Create the blueprint principal** — Creates the service principal for the blueprint (this is **not** autocreated and must be done explicitly).
...
- Rerun the AI-guided setup with updated values — the idempotent checks will skip resources that already exist correctly.
