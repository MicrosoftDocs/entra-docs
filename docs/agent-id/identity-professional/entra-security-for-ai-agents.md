...
:::image type="content" source="media/entra-security-for-ai-agents/entra-agent-identity-capabilities.png" alt-text="Diagram agent security capabilities offered by Entra agent ID.":::
