...
Agent identities can enter your tenant through various channels. See [this article for details](/entra/identity-platform/agent-id-identity-creation). You can block creation of agent identities through the following methods.
