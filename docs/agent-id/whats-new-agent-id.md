...
- [Configure Microsoft Entra ID Auth SDK (sidecar) for agent identities](microsoft-entra-sdk-for-agent-identities.md) - SDK configuration for token acquisition.
