...
### Permission propagation takes 30ΓÇô120+ seconds

After you grant admin consent for Agent ID permissions, newly granted permissions don't appear in tokens immediately. The token endpoint serves cached claims, and propagation can take 30ΓÇô120 seconds or more.
...
- **Permission propagation delay**: Wait 1ΓÇô2 minutes after admin consent and retry.
