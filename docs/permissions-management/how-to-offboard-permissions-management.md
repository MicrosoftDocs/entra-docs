...
> [!NOTE] 
> User must have the [Permissions Management Administrator](/identity/role-based-access-control/permissions-reference.md) and [Cloud Application Administrator](/identity/role-based-access-control/permissions-reference.md) role assignments to perform this task. 
