...
> [!NOTE]
> You must have [Permissions Management Administrator](../identity/role-based-access-control/delegate-by-task.md/#permissions-management) permissions to perform the tasks in this article.
