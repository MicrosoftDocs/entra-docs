...
:::image type="content" source="media/workbook-risk-based-policy-impact/workbook-risk-based-impact-parameters.png" alt-text="ALT" lightbox="media/workbook-risk-based-policy-impact/workbook-risk-based-impact-parameters.png":::
...
:::image type="content" source="media/workbook-risk-based-policy-impact/workbook-risk-based-impact-summary.png" alt-text="ALT" lightbox="media/workbook-risk-based-policy-impact/workbook-risk-based-impact-summary.png":::
...
:::image type="content" source="media/workbook-risk-based-policy-impact/workbook-risk-based-impact-user.png" alt-text="ALT" lightbox="media/workbook-risk-based-policy-impact/workbook-risk-based-impact-user.png":::
...
:::image type="content" source="media/workbook-risk-based-policy-impact/workbook-risk-based-impact-sign-in.png" alt-text="ALT" lightbox="media/workbook-risk-based-policy-impact/workbook-risk-based-impact-sign-in.png":::
...
:::image type="content" source="media/workbook-risk-based-policy-impact/workbook-risk-based-impact-federated.png" alt-text="ALT" lightbox="media/workbook-risk-based-policy-impact/workbook-risk-based-impact-federated.png":::
...
:::image type="content" source="media/workbook-risk-based-policy-impact/workbook-risk-based-impact-legacy.png" alt-text="ALT" lightbox="media/workbook-risk-based-policy-impact/workbook-risk-based-impact-legacy.png":::
...
:::image type="content" source="media/workbook-risk-based-policy-impact/workbook-risk-based-impact-trusted-network.png" alt-text="ALT" lightbox="media/workbook-risk-based-policy-impact/workbook-risk-based-impact-trusted-network.png":::
