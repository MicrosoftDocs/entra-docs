...
For more information on workload identity risk detections go to [Securing workload identities](https://learn.microsoft.com/en-us/entra/id-protection/concept-workload-identity-risk).
