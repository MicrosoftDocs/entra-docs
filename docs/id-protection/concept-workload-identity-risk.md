...
| Suspicious API Traffic | Offline | This risk detection is reported when abnormal GraphAPI traffic or directory enumeration of a service principal is observed. The Suspicious API Traffic for service princpals may indicate abnormal reconnaissance or data exfiltration. |
