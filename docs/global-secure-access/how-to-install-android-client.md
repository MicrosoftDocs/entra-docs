...
This process is covered in detail in the [Deploy Microsoft Defender for Endpoint on Android with Microsoft Intune](/microsoft365/defender-endpoint/android-intune&preserve-view=true#deploy-on-device-administrator-enrolled-devices) article.
