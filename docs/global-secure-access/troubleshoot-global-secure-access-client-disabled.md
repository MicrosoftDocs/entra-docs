...
description: This document provides troubleshooting guidance for the Global Secure Access client when is shows the "disabled by your organization" error message.
