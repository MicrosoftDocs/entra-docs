...
#customer intent: As a security administrator, I want to configure the AI Gateway prompt injection protection policies so that I can safeguard AI applications against malicious inputs.
...
1. Configure TLS inspection with either a [Microsoft-managed certificate](how-to-transport-layer-security-settings-managed-certificate.md) or [your own certificate](how-to-transport-layer-security-settings.md), and then configure [TLS inspection policies](how-to-transport-layer-security.md).
...
1. On the **Prompt rule** page:
    ...
    :::image type="content" source="media/how-to-ai-prompt-injection-protection/prompt-rule.png" alt-text="Screen shot of the Prompt Rule screen with example values in the form fields." lightbox="media/how-to-ai-prompt-injection-protection/prompt-rule.png":::
...
1. Select the Prompt Injection Protection prompt policy you created earlier.
1. To link the Prompt Injection Protection prompt policy, select **Add**.
