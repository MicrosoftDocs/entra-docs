...
The Global Secure Access dashboard provides visualizations of the network traffic that the Microsoft Entra Private Access and Microsoft Entra Internet Access services acquire. The dashboard compiles data from your network configurations, including devices, users, and tenants, into several widgets that provide answers to the following questions:
...
- Configured network traffic for the service to acquire and view data on the dashboard. On the dashboard, select **Get started with the dashboard** for an overview video.
...
:::image type="content" source="media/concept-traffic-dashboard/traffic-dashboard.png" alt-text="Screenshot of the Microsoft Entra admin center, with the Dashboard navigation link highlighted." lightbox="media/concept-traffic-dashboard/traffic-dashboard.png":::
...
:::image type="content" source="media/concept-traffic-dashboard/dashboard-alerts-notifications.png" alt-text="Screenshot of the alerts and notifications widget showing two alert types." lightbox="media/concept-traffic-dashboard/dashboard-alerts-notifications.png":::
...
:::image type="content" source="media/concept-traffic-dashboard/dashboard-usage-profiling.png" alt-text="Screenshot of the usage profiling widget." lightbox="media/concept-traffic-dashboard/dashboard-usage-profiling.png":::
...
The top-used destinations list includes all types of traffic and sorts by the number of transactions. To narrow the results, select a different traffic type or filter by the following options:
...
:::image type="content" source="media/concept-traffic-dashboard/top-destinations.png" alt-text="Screenshot of the top destinations widget with the number of transactions field highlighted." lightbox="media/concept-traffic-dashboard/top-destinations.png":::

Change the results to show all traffic or filter by Internet Access, Private Access, or Microsoft traffic.

Select **View all destinations** to see more details about the destinations.
...
:::image type="content" source="media/concept-traffic-dashboard/cross-tenant-access.png" alt-text="Screenshot of the cross-tenant access widget." lightbox="media/concept-traffic-dashboard/cross-tenant-access.png":::

Select **Configure tenant restrictions** to go to the **Session management** area of Global Secure Access, where you can check the settings of your tenant restrictions.
...
The widget defaults to showing blocked and allowed traffic, but you can use the **Blocked** or **Allowed** filter options to view one or the other. Sort the results by the following categories:
...
:::image type="content" source="media/concept-traffic-dashboard/web-content-filtering.png" alt-text="Screenshot of the traffic categories accessed by users and devices." lightbox="media/concept-traffic-dashboard/web-content-filtering.png":::

## Device status

The **Device status** widgets display the active and inactive devices that you deployed.

- **Active devices**: The number of distinct device IDs seen in the last 24 hours and the percentage change during that time.
- **Inactive devices**: The number of distinct device IDs that the service saw in the last seven days, but not during the last 24 hours. The widget also shows the percentage change during the last 24 hours.

:::image type="content" source="media/concept-traffic-dashboard/device-status.png" alt-text="Screenshot of the device status widgets." lightbox="media/concept-traffic-dashboard/device-status.png":::
...
:::image type="content" source="media/concept-traffic-dashboard/alerts-widget.png" alt-text="Screenshot of the Alerts widget showing alerts from the last month." lightbox="media/concept-traffic-dashboard/alerts-widget.png":::
