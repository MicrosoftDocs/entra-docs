...
1. After 30 minutes, **Refresh** to view the hub on the **Hubs** page, and then select **Go to resource** to go to the resource.
...
- [Simulate remote network connectivity using Azure VNG](how-to-simulate-remote-network.md)
