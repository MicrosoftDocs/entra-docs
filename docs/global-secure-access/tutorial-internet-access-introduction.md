...
description: Learn about Microsoft Entra Internet Access labs covering web filtering, TLS inspection, threat intelligence, and more.
ms.topic: tutorial
ms.date: 03/07/2026
...
This learning lab series provides hands-on experience with Microsoft Entra Internet Access, a cloud-delivered Secure Web Gateway (SWG) and AI Gateway.

In this tutorial, you learn how to:
> [!div class="checklist"]
> - Understand what Microsoft Entra Internet Access is and how it works
...
Microsoft Entra Internet Access is part of Microsoft's Security Service Edge (SSE) solution. It works by routing internet traffic through Microsoft's globally distributed cloud proxies, where security policies are applied before traffic reaches its destination.
...
This series of exercises covers the fundamentals of Microsoft Entra Internet Access. **The exercises assume you've gone in order.** If you skip around, you might miss a step. For example, in the baseline web filtering tutorial, you create a security profile and assign it to a Conditional Access policy. Subsequent labs instruct you to assign the new policy to this existing security profile rather than creating a new security profile and Conditional Access policy each time.
...
|----------|----------------|
| [Enable Internet Access](tutorial-internet-access-enable-traffic-forwarding.md) | How traffic forwarding works and how to route internet traffic through GSA. |
...
| [TLS inspection](tutorial-internet-access-tls-inspection.md) | Why encrypted traffic inspection is essential for modern security. |
