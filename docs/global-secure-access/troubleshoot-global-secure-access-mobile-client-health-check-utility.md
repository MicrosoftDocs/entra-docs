...
1. Device enrollment: [Enroll the device in Intune](/intune/intune-service/fundamentals/deployment-guide-enrollment)
2. Device compliance: If not, open the **Company portal** app and [resolve compliance issues](/intune/intune-service/user-help/check-device-access-windows-cpapp).
