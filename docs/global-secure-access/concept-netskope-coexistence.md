...
Bypass Microsoft Entra service Fully Qualified Domain Name (FQDN) and Internet Protocol (IP) in tunnel settings. 

1. Navigate to **Policies** > **Profile** > **Network Location** > **New Network Location** > **Single Object**. 
