...
> [!NOTE]
> The clients must be installed on Windows 10 or Windows 11 Entra joined device, Microsoft Entra hybrid joined, or a macOS Monterey device registered to Entra with Intune Company Portal. 
