---
title: Microsoft Security Service Edge Solution Deployment Guide for Microsoft Entra Internet Access for M365
description: Deploy and verify Microsoft Entra Internet Access for M365
...
ms.author: jricketts
---
# Microsoft Security Service Edge Solution Deployment Guide for Microsoft Entra Internet Access for M365 Proof of Concept
...
This section describes how to enforce compliant network on access to M365 traffic, protect the connection to the Microsoft Security Service Edge with Conditional Access, and prevent external identities from accessing external tenants on your managed devices and/or networks by using universal tenant restrictions v2.
 > [!NOTE]
...
7. Attempt to sign-in to SharePoint Online or Exchange Online and verify that you are prompted to authenticate to Global Secure Access.
 :::image type="content" source="<media/sse-poc-deployment-guide/screenshot-global-secure-access-credentials-prompt.png>" alt-text="<Screenshot of the Global Secure Access credentials prompt window.>":::
     > [!NOTE]
...
:::image type="content" source="media/sse-deployment-guide-m365/screenshot-sign-in-logs-user-sign-ins-interactive.png" alt-text="Screenshot of list of sign-in logs window showing User sign-ins interactive tab.":::
:::image type="content" source="media/sse-deployment-guide-m365/screenshot-sign-in-logs-conditional-access.png" alt-text="Screenshot of sign-in logs window showing Conditional Access tab.":::
...
:::image type="content" source="media/sse-deployment-guide-m365/screenshot-global-secure-access-client-connected.png" alt-text="Screenshot of the Global Secure Access Client icon showing Connected status indicator.":::
10. Use your test user to sign in to SharePoint Online or Exchange Online by using your test device.
   ...
   1. In the sign-in logs, confirm that the Conditional Access policy that blocks access outside compliant networks indicates **Not Applied**.
    :::image type="content" source="media/sse-deployment-guide-m365/screenshot-sign-in-logs-success.png" alt-text="Screenshot of a line in the sign-in logs window showing success indicator.":::
    :::image type="content" source="media/sse-deployment-guide-m365/screenshot-logs-conditional-access-not-applied.png" alt-text="Screenshot of sign-in logs-window showing Conditional Access tab highlighting a line where Result column is Not Applied.":::
11. From a different device without the Global Secure Access Client, use your test user identity to attempt to sign in to SharePoint Online or Exchange Online. Alternatively, you can right-click the Global Secure Access Client in your system tray and click **Pause**, and then use your test user identity to attempt to sign in to SharePoint Online or Exchange Online on the same device.
   ...
   1. In the sign-in logs, confirm the Conditional Access policy that blocks access outside compliant networks was applied.
    :::image type="content" source="media/sse-deployment-guide-m365/screenshot-log-in-you-cannot-access.png" alt-text="Screenshot of log-in window after submitting credentials showing You cannot access this right now message.":::
    :::image type="content" source="media/sse-deployment-guide-m365/screenshot-sign-in-logs-failure.png" alt-text="Screenshot of a line in the sign-in logs window showing failure indicator.":::
    :::image type="content" source="media/sse-deployment-guide-m365/screenshot-logs-conditional-access-failure.png" alt-text="Screenshot of sign-in logs-window showing Conditional Access tab highlighting a line where Result column is Failure.":::
...
:::image type="content" source="media/sse-deployment-guide-m365/screenshot-log-in-access-is-blocked.png" alt-text="Screenshot of log-in window after submitting credentials showing Access is blocked message.":::
...
:::image type="content" source="media/sse-deployment-guide-m365/screenshot-sign-in-logs-blocked-logged.png" alt-text="Screenshot of sign-in logs window line where Result column is Failure.":::
:::image type="content" source="media/sse-deployment-guide-m365/screenshot-sign-in-log-basic-info-tab.png" alt-text="Screenshot of sign-in logs showing Basic info tab for an item that indicates a Failure reason of tenant restrictions policy not allowing access.":::
...
This section demonstrates how Microsoft Entra Internet Access for M365 overcomes these issues by preserving the user's original source IP address, simplifying security investigations and troubleshooting.
...
:::image type="content" source="media/sse-deployment-guide-m365/screenshot-sign-in-logs-location-tab.png" alt-text="Screenshot of sign-in logs showing Location tab for an item.":::
:::image type="content" source="media/sse-deployment-guide-m365/screenshot-logs-conditional-access-not-applied.png" alt-text="Screenshot of sign-in logs-window showing Conditional Access tab highlighting a line where Result column is Not Applied.":::
...
:::image type="content" source="media/sse-deployment-guide-m365/screenshot-gsa-client-options-pause.png" alt-text="Screenshot of the Global Secure Access Client options menu showing the Pause option highlighted.":::
:::image type="content" source="media/sse-deployment-guide-m365/screenshot-global-secure-access-client-disabled.png" alt-text="Screenshot of the Global Secure Access Client icon showing as disabled.":::
...
6. View the sign-in log for the last sign-in attempt.
   ...
   1. Confirm that the report-only Conditional Access policy would have failed as the traffic didn't route through Microsoft Entra Internet Access for M365.
:::image type="content" source="media/sse-deployment-guide-m365/screenshot-sign-in-logs-location-tab.png" alt-text="Screenshot of sign-in logs showing Location tab for an item.":::
:::image type="content" source="media/sse-deployment-guide-m365/screenshot-sign-in-logs-report-only-failure.png" alt-text="Screenshot of sign-in logs showing Report-only tab for an item with Report-only: Failure in the Result column.":::
