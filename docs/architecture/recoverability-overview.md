...
| Groups other than Microsoft 365 Groups and security groups| Users assigned to the group.<br>Conditional Access policies to which the group is assigned.<br>Applications to which the group is assigned access. |
...
A Delete event for applications, service principals, users, Microsoft 365 Groups, and security groups is a soft delete. For any other object type, it's a hard delete.
