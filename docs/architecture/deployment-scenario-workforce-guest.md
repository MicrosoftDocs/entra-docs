...
1. After the setup process is complete, you see a default workplace credential available to edit and offer to employees of your tenant on their **My Account** page.
   :::image type="content" source="media/workforce-guest-scenario/verified-id-overview.png" alt-text="Example of Verified ID, Overview.":::
1. Sign in to the test user's **My Account** with their Microsoft Entra credentials. Select **Get my Verified ID** to issue a verified workplace credential.
   :::image type="content" source="media/workforce-guest-scenario/my-verified-id.png" alt-text="Example of My Account, Overview with a red ellipse highlighting the Get my Verified ID control.":::
...
1. Confirm the new organization (that inherits its access settings from default settings) in **Organizational settings**.
   :::image type="content" source="media/workforce-guest-scenario/organizational-settings-inherited.png" alt-text="Example of Organizational settings with red boxes highlighting Inherited from default in the Inbound access and Outbound access columns.":::
...
1. Select **+New catalog**.
   :::image type="content" source="media/workforce-guest-scenario/identity-governance-catalogs-inline.png" alt-text="Example of New access review, Enterprise applications, All applications, Identity Governance, New catalog." lightbox="media/workforce-guest-scenario/identity-governance-catalogs-expanded.png":::
...
1. To create access packages in this catalog for internal users, select **Enabled for external users** \> **No**.
   :::image type="content" source="media/workforce-guest-scenario/identity-governance-new-catalog.png" alt-text="Example of New catalog with No selected for the Enabled for external users control.":::
...
1. In **Role**, select the role to which you want users assigned for each resource.
   :::image type="content" source="media/workforce-guest-scenario/resource-roles.png" alt-text="Example of Resources roles with a red box highlighting the Role column.":::
...
1. Select **Specific reviewers**. Select **Self Review**.
   :::image type="content" source="media/workforce-guest-scenario/new-access-package.png" alt-text="Example of New access package.":::
...
1. Confirm settings. Select **Enable policy**.
   :::image type="content" source="media/workforce-guest-scenario/conditional-access-policies-new-inline.png" alt-text="Example of Conditional Access Policies, New, Sign-in risk. A red box emphasizes User risk and Sign-in risk." lightbox="media/workforce-guest-scenario/conditional-access-policies-new-expanded.png":::
...
1. The system displays an information banner with a message such as, *To request access to this access package you need to present your Verifiable Credentials*. Select **Request Access**. To launch Microsoft Authenticator, scan the QR Code with your phone. Share your credentials.
   :::image type="content" source="media/workforce-guest-scenario/present-verified-id.png" alt-text="Example of My Access, Available, Access packages, Present Verified ID, QR Code.":::
