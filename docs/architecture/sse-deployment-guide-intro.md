...
:::image type="content" source="media/sse-deployment-guide-intro/diagram-private-access-architecture-expanded.png" alt-text="Diagram that shows minimum required architecture components for Entra ID tenant."::: 
