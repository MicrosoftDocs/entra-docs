...
|Migrate product licenses|Refer to [Change the license for a single user in a licensed group in Microsoft Entra ID](~/identity/users/licensing-group-advanced.md).|
