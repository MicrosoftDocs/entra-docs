...
#Customer intent: As a software developer, I want to understand how third-party fraud protection integrates with native authentication flows to assess risk and protect SMS-based multifactor authentication.
---
...
- [SMS throttling limits enforced by Microsoft Entra External ID](../external-id/customers/reference-service-limits.md#telephony-throttling-limits).
