...
- "logoUrl" is a read-only property. You can't edit it in app  manifest. Please navigate to "branding and property" page in your  desired app registration and use "Upload new logo" to upload a new logo.
