...
FIDO2 is supported for Android apps that use MSAL with either ASWebAuthenticationSession or broker integration. Broker is shipped in Microsoft Authenticator, Company Portal, or Link to Windows app on Android.
