---
title: Retrieve and return data from an OnAttributeCollectionStart event (preview)
...
# Retrieve and return data from an OnAttributeCollectionStart event (preview)
