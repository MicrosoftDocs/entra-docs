...
This is required for Mac devices that enable Platform SSO and for devices that have opted-in to [Secure Enclave backed device identity](#enable-secure-enclave-based-storage-of-device-identity-keys).
