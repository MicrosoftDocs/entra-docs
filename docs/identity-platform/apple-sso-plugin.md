...
> [!IMPORTANT]
> Temporary exclusions from secure storage are limited to 6 months and are discouraged as they may prevent your organization from benefiting from future security enhancements and could limit support options when Microsoft eventually phases out legacy storage methods. 
