...
If you see this error message during testing, it is recommended that you contact the vendor of the application to alert them to the incompatibility with the new storage location. 
