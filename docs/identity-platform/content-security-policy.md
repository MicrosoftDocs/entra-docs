...
> Impact: Applies only to browser-based sign-in at `login.microsoftonline.com`. External ID customers using custom domains and MSAL/API flows are **not affected**.
