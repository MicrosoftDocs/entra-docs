...
> | ------- | -------- | ------------- | -------------- |
> | Angular | &#8226; [Sign in users](https://github.com/Azure-Samples/ms-identity-docs-code-javascript/tree/main/angular-spa) | | | [Quickstart](quickstart-single-page-app-angular-sign-in.md) | [Tutorial](tutorial-single-page-app-angular.md) |
