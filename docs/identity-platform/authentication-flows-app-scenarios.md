...
For more information, see [Sign in users in a sample web app](./quickstart-web-app-sign-in.md).
...
For more information, see [Desktop app that calls web APIs](scenario-desktop-app-configuration.md).
...
For more information, see [Mobile app that calls web APIs](scenario-mobile-app-configuration.md).
...
For more information, see [Protected web API](scenario-protected-web-api-expose-scopes.md).
...
For more information, see [Web API that calls web APIs](scenario-web-api-call-api-app-configuration.md).
...
For more information, see [Daemon application that calls web APIs](scenario-daemon-app-configuration.md).
...
| --- | --- | --- | --- |
| [![Single-Page App with Auth code](media/scenarios/spa-app-auth.svg)](scenario-spa-app-configuration.md) | [Single-page app](scenario-spa-app-configuration.md) | [Authorization code](v2-oauth2-auth-code-flow.md) with PKCE | Work or school accounts, personal accounts, and Azure Active Directory B2C (Azure AD B2C) |
| [![Single-Page App with Implicit](media/scenarios/spa-app.svg)](scenario-spa-app-configuration.md) | [Single-page app](scenario-spa-app-configuration.md) | [Implicit](v2-oauth2-implicit-grant-flow.md) | Work or school accounts, personal accounts, and Azure Active Directory B2C (Azure AD B2C) |
| [![Web app that signs in users](media/scenarios/scenario-webapp-signs-in-users.svg)](quickstart-web-app-sign-in.md) | [Web app that signs in users](quickstart-web-app-sign-in.md) | [Authorization code](v2-oauth2-auth-code-flow.md) | Work or school accounts, personal accounts, and Azure AD B2C |
| [![Web app that calls web APIs](media/scenarios/web-app.svg)](scenario-web-app-call-api-app-configuration.md) | [Web app that calls web APIs](scenario-web-app-call-api-app-configuration.md) | [Authorization code](v2-oauth2-auth-code-flow.md) | Work or school accounts, personal accounts, and Azure AD B2C |
| [![Desktop app that calls web APIs](media/scenarios/desktop-app.svg)](scenario-desktop-app-configuration.md) | [Desktop app that calls web APIs](scenario-desktop-app-configuration.md) | Interactive by using [authorization code](v2-oauth2-auth-code-flow.md) with PKCE | Work or school accounts, personal accounts, and Azure AD B2C |
...
| [![Mobile app that calls web APIs](media/scenarios/mobile-app.svg)](scenario-mobile-app-configuration.md) | [Mobile app that calls web APIs](scenario-mobile-app-configuration.md) | Interactive by using [authorization code](v2-oauth2-auth-code-flow.md) with PKCE | Work or school accounts, personal accounts, and Azure AD B2C |
| | | [Resource owner password](v2-oauth-ropc.md) | Work or school accounts and Azure AD B2C |
| [![Daemon app that calls web APIs](media/scenarios/daemon-app.svg)](scenario-daemon-app-configuration.md) | [Daemon app that calls web APIs](scenario-daemon-app-configuration.md) | [Client credentials](v2-oauth2-client-creds-grant-flow.md) | App-only permissions that have no user and are used only in Microsoft Entra organizations |
| [![Web API that calls web APIs](media/scenarios/web-api.svg)](scenario-web-api-call-api-app-configuration.md) | [Web API that calls web APIs](scenario-web-api-call-api-app-configuration.md) | [On-behalf-of](v2-oauth2-on-behalf-of-flow.md) | Work or school accounts and personal accounts |
...
|--|--|--|--|--|--|--|
| [Single-page app](scenario-spa-app-configuration.md) <br/>[![Single-Page App Auth](media/scenarios/spa-app-auth.svg)](scenario-spa-app-configuration.md) | ![MSAL.js](media/sample-v2-code/small_logo_js.png)<br/>MSAL.js | ![MSAL.js](media/sample-v2-code/small_logo_js.png)<br/>MSAL.js | ![MSAL.js](media/sample-v2-code/small_logo_js.png)<br/>MSAL.js | ![MSAL.js](media/sample-v2-code/small_logo_js.png) MSAL.js | ![MSAL.js](media/sample-v2-code/small_logo_js.png)<br/>MSAL.js
| [Single-page app](scenario-spa-app-configuration.md) <br/>[![Single-Page App Implicit](media/scenarios/spa-app.svg)](scenario-spa-app-configuration.md) | ![MSAL.js](media/sample-v2-code/small_logo_js.png)<br/>MSAL.js | ![MSAL.js](media/sample-v2-code/small_logo_js.png)<br/>MSAL.js | ![MSAL.js](media/sample-v2-code/small_logo_js.png)<br/>MSAL.js | ![MSAL.js](media/sample-v2-code/small_logo_js.png) MSAL.js | ![MSAL.js](media/sample-v2-code/small_logo_js.png)<br/>MSAL.js
| [Web app that signs in users](./quickstart-web-app-sign-in.md) <br/>[![Web app that signs-in users](media/scenarios/scenario-webapp-signs-in-users.svg)](./quickstart-web-app-sign-in.md) | ![ASP.NET Core](media/sample-v2-code/small_logo_NETcore.png)<br/>ASP.NET Core ![MSAL Node](media/sample-v2-code/small-logo-nodejs.png) <br/>MSAL Node<br/>| ![ASP.NET Core](media/sample-v2-code/small_logo_NETcore.png)<br/>ASP.NET Core ![MSAL Node](media/sample-v2-code/small-logo-nodejs.png) <br/>MSAL Node<br/>| ![ASP.NET Core](media/sample-v2-code/small_logo_NETcore.png)<br/>ASP.NET Core ![MSAL Node](media/sample-v2-code/small-logo-nodejs.png) <br/>MSAL Node<br/>
| [Web app that calls web APIs](scenario-web-api-call-api-app-configuration.md) <br/> <br/>[![Web app that calls web APIs](media/scenarios/web-app.svg)](scenario-web-api-call-api-app-configuration.md) | ![ASP.NET Core](media/sample-v2-code/small_logo_NETcore.png)<br/>ASP.NET Core + MSAL.NET ![MSAL Java](media/sample-v2-code/small_logo_java.png) <br/>MSAL Java<br/>![MSAL Python](media/sample-v2-code/small_logo_python.png)<br/>Flask + MSAL Python ![MSAL Node](media/sample-v2-code/small-logo-nodejs.png) <br/>MSAL Node<br/>| ![ASP.NET Core](media/sample-v2-code/small_logo_NETcore.png)<br/>ASP.NET Core + MSAL.NET ![MSAL Java](media/sample-v2-code/small_logo_java.png)<br/>MSAL Java<br/>![MSAL Python](media/sample-v2-code/small_logo_python.png)<br/>Flask + MSAL Python ![MSAL Node](media/sample-v2-code/small-logo-nodejs.png) <br/>MSAL Node<br/>| ![ASP.NET Core](media/sample-v2-code/small_logo_NETcore.png)<br/>ASP.NET Core + MSAL.NET ![MSAL Java](media/sample-v2-code/small_logo_java.png)<br/>MSAL Java<br/> ![MSAL Python](media/sample-v2-code/small_logo_python.png)<br/>Flask + MSAL Python ![MSAL Node](media/sample-v2-code/small-logo-nodejs.png) <br/>MSAL Node<br/>
| [Desktop app that calls web APIs](scenario-desktop-app-configuration.md) <br/> <br/>[![Desktop app that calls web APIs](media/scenarios/desktop-app.svg)](scenario-desktop-app-configuration.md) ![Device code flow](media/scenarios/device-code-flow-app.svg) | ![.NET](media/sample-v2-code/small_logo_NETcore.png)MSAL.NET ![MSAL Java](media/sample-v2-code/small_logo_java.png)<br/>MSAL Java<br/> ![MSAL Python](media/sample-v2-code/small_logo_python.png)<br/>MSAL Python ![MSAL Node](media/sample-v2-code/small-logo-nodejs.png) <br/>MSAL Node<br/>| ![.NET](media/sample-v2-code/small_logo_NETcore.png)MSAL.NET ![MSAL Java](media/sample-v2-code/small_logo_java.png)<br/>MSAL Java<br/>![MSAL Python](media/sample-v2-code/small_logo_python.png)<br/>MSAL Python ![MSAL Node](media/sample-v2-code/small-logo-nodejs.png) <br/>MSAL Node<br/>| ![.NET](media/sample-v2-code/small_logo_NETcore.png)MSAL.NET ![MSAL Java](media/sample-v2-code/small_logo_java.png)<br/>MSAL Java<br/>![MSAL Python](media/sample-v2-code/small_logo_python.png)<br/>MSAL Python <br/> ![MSAL Node](media/sample-v2-code/small-logo-nodejs.png) <br/>MSAL Node<br/> ![iOS / Objective C or swift](media/sample-v2-code/small_logo_iOS.png) MSAL.objc |
| [Mobile app that calls web APIs](scenario-mobile-app-configuration.md) <br/> [![Mobile app that calls web APIs](media/scenarios/mobile-app.svg)](scenario-mobile-app-configuration.md) | ![UWP](media/sample-v2-code/small_logo_windows.png) MSAL.NET | | | ![iOS / Objective C or swift](media/sample-v2-code/small_logo_iOS.png) MSAL.objc | ![Android](media/sample-v2-code/small_logo_Android.png) MSAL.Android
| [Daemon app](scenario-daemon-app-configuration.md) <br/> [![Daemon app](media/scenarios/daemon-app.svg)](scenario-daemon-app-configuration.md) | ![.NET](media/sample-v2-code/small_logo_NETcore.png)MSAL.NET ![MSAL Java](media/sample-v2-code/small_logo_java.png)<br/>MSAL Java<br/>![MSAL Python](media/sample-v2-code/small_logo_python.png)<br/>MSAL Python ![MSAL Node](media/sample-v2-code/small-logo-nodejs.png) <br/>MSAL Node<br/>| ![.NET](media/sample-v2-code/small_logo_NETcore.png) MSAL.NET ![MSAL Java](media/sample-v2-code/small_logo_java.png)<br/>MSAL Java<br/>![MSAL Python](media/sample-v2-code/small_logo_python.png)<br/>MSAL Python ![MSAL Node](media/sample-v2-code/small-logo-nodejs.png) <br/>MSAL Node<br/>| ![.NET](media/sample-v2-code/small_logo_NETcore.png)MSAL.NET ![MSAL Java](media/sample-v2-code/small_logo_java.png)<br/>MSAL Java<br/>![MSAL Python](media/sample-v2-code/small_logo_python.png)<br/>MSAL Python ![MSAL Node](media/sample-v2-code/small-logo-nodejs.png) <br/>MSAL Node<br/>
| [Web API that calls web APIs](scenario-web-api-call-api-app-configuration.md) <br/><br/> [![Web API that calls web APIs](media/scenarios/web-api.svg)](scenario-web-api-call-api-app-configuration.md) | ![ASP.NET Core](media/sample-v2-code/small_logo_NETcore.png)<br/>ASP.NET Core + MSAL.NET ![MSAL Java](media/sample-v2-code/small_logo_java.png)<br/>MSAL Java<br/>![MSAL Python](media/sample-v2-code/small_logo_python.png)<br/>MSAL Python ![MSAL Node](media/sample-v2-code/small-logo-nodejs.png) <br/>MSAL Node<br/>| ![.NET](media/sample-v2-code/small_logo_NETcore.png)<br/>ASP.NET Core + MSAL.NET ![MSAL Java](media/sample-v2-code/small_logo_java.png)<br/>MSAL Java<br/>![MSAL Python](media/sample-v2-code/small_logo_python.png)<br/>MSAL Python ![MSAL Node](media/sample-v2-code/small-logo-nodejs.png) <br/>MSAL Node<br/>| ![.NET](media/sample-v2-code/small_logo_NETcore.png)<br/>ASP.NET Core + MSAL.NET ![MSAL Java](media/sample-v2-code/small_logo_java.png)<br/>MSAL Java<br/>![MSAL Python](media/sample-v2-code/small_logo_python.png)<br/>MSAL Python ![MSAL Node](media/sample-v2-code/small-logo-nodejs.png) <br/>MSAL Node<br/>
