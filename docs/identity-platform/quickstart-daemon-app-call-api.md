...
description: A daemon app code sample quickstart that shows how to acquired an access token to call a protected web API by using Microsoft identity platform
author: kengaderdus
manager: mwongerapk
