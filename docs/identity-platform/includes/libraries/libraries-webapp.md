...
| ASP.NET Core         | [ASP.NET Core](https://github.com/dotnet/aspnetcore)                                                                      | [Microsoft.AspNetCore.Authentication](https://www.nuget.org/packages/Microsoft.AspNetCore.Authentication/) | [Quickstart](../../quickstart-web-app-dotnet-core-sign-in.md) | ![Library can request ID tokens for user sign-in.][y]                | ![Library cannot request access tokens for protected web APIs.][n]             | GA                                                           |
