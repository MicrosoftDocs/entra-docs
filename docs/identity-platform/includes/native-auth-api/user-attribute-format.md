...
When you [create a sign-up user-flow](../../../external-id/customers/how-to-user-flow-sign-up-sign-in-customers.md), you add to it a user attribute that you want to collect from the user during sign-up. The name of the user attribute in the Microsoft Entra admin center isn't similar to how you reference it the native authentication API.
