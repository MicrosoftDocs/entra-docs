...
:::image type="content" source="media/decentralized-identifier-overview/microsoft-did-system.png" alt-text="overview of Microsoft's verifiable credential environment":::
...
:::image type="content" source="media/decentralized-identifier-overview/did-overview.png" alt-text="microsoft-did-overview":::
...
:::image type="content" source="media/decentralized-identifier-overview/issuer-user-verifier.png" alt-text="roles in a verifiable credential environment":::
