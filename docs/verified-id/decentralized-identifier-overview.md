...
:::image type="content" source="media/decentralized-identifier-overview/microsoft-did-system.png" alt-text="diagram of a Microsoft's verifiable credential environment.":::
