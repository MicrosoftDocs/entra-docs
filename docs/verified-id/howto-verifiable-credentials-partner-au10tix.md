...
1. Look for AU10TIX in the **Search/select issuers** drop-down.
   ...
   [ :::image type="content" source="./media/verified-id-partner-au10tix/select-issuers.png" alt-text="Screenshot of the portal section used to choose issuers.":::](./media/verified-id-partner-au10tix/select-issuers.png#lightbox)
