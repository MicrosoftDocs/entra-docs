...
1. Authenticator launches [https://aka.ms/mfasetup](https://aka.ms/mfasetup) in the browser on your mobile device. You need to sign in again with your test user's credentials.
1. In the **Set up your account in the app**, select **Pair your account to the app by clicking this link**. The Microsoft Authenticator app opens and you see your test user as an added account.
