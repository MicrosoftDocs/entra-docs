...
>[!Note]
>For a multi-tenant model, IDV should explore setting up dedicated authorities if there is a 1:1 relationship required with the customer. Please refer [Admin API](admin-api.md) section of the docs for creating authorities. 
