...
1.	Replace did.json on all webservers it was previously deployed at. If you edited it manually, make sure it is has valid JSON with a tool like https://jsonformatter.org/. Before continuing, make sure that you can retrieve the new did.json document from the public internet with a browser.
