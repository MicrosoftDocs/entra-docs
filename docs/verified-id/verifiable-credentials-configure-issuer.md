...
1. After you [set up your tenant](verifiable-credentials-configure-tenant.md), the **Create credential** page should appear. Alternatively, you can select **Credentials** in the left hand menu and select **+ Add a credential**.
...
1. You're prompted to enter a PIN code that is displayed in the screen where you scanned the QR code. The PIN adds an extra layer of protection to the issuance. The PIN code is randomly generated every time an issuance QR code is displayed.
