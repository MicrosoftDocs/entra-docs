...
> [!NOTE]
> If the [Identity Risk Management Agent](/entra/id-protection/identity-risk-management-agent-get-started) is enabled in your tenant, you will see a separate risky user summary in thie view. 
