...
You can resolve this issue by migrating to use [Microsoft Entra Agent ID](../agent-id/identity-professional/security-for-ai.md). Select **Create agent identity** from either the banner message on the agent page or the **Identity and permissions** section of the agent settings.
