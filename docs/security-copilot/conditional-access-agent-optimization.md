...
- Enable [activity-based runs](conditional-access-agent-optimization-settings.md#activity-based-runs-preview) to trigger the agent when relevant tenant changes occur (Preview)
