...
The Conditional Access Optimization Agent knowledge base uses the following lifecycle:
...
This model allows the agent to reason with context instead of treating guidance as static rules.

## What guidance can the Knowledge Base use?

The Conditional Access Optimization Agent can follow guidance in several key areas.
