...
The **Agent summary** at the top of the Conditional Access Optimization Agent page provides a quick summary of what the agent discovered in the last 30 days. The total number of [security compute units (SCU)](/copilot/security/manage-usage) consumed by the agent is also provided.
...
:::image type="content" source="media/conditional-access-agent-optimization-logs-metrics/insights-dashboard.png" alt-text="Screenshot of the insights dashboard." lightbox="media/conditional-access-agent-optimization-logs-metrics/insights-dashboard.png":::
