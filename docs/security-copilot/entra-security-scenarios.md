...
:::image type="content" source="./media/copilot-security-entra/data-exploration-entra.png" alt-text="Screenshot that shows Data Exploration in Security Copilot for Microsoft Entra.":::
