...
**Remediation action**
- [Configure adaptive session lifetime policies](/entra/identity/conditional-access/howto-conditional-access-session-lifetime) so sign-in frequency policies have shorter live sign-in sessions.