...
# minimumlicense: Microsoft Entra Internet Access, Microsoft Entra Private Access <!-- VERIFY: String ID not found in license table, best-guess friendly name -->
# sfipillar: Protect networks
# 25380 is the same content.
# category: Network
# risklevel: Medium
# userimpact: Low
