...
# minimumlicense: Microsoft Entra ID P1, Microsoft Entra Internet Access, Microsoft Entra Private Access <!-- VERIFY: Confirm minimum license for Universal CAE — if P1 alone is sufficient, remove Internet/Private Access; if GSA is required, remove P1 -->
