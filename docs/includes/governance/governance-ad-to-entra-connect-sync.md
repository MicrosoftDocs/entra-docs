...
1. In **Express settings**, select **Use express settings**.
   ...
   :::image type="content" source="~/identity/hybrid/connect/media/tutorial-password-hash-sync/express1.png" alt-text="Screenshot that shows the Express settings screen and the Use express settings button.":::
...
1. Verify that the new users appear in your tenant.
   ...
   :::image type="content" source="~/identity/hybrid/connect/media/tutorial-password-hash-sync/sync1.png" alt-text="Screenshot that shows verifying that users were synced in Microsoft Entra ID.":::
