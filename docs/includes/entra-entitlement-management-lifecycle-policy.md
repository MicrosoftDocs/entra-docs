...
On the **Lifecycle** tab, you specify when an identities assignment to the access package expires. You can also specify whether identities can extend their assignments.
