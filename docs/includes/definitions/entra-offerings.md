...
- **Microsoft Entra Suite** - The suite combines Microsoft Entra products to protect and verify any identity. The suite provides secure access from anywhere to any app or resource (cloud or on-premises). The Microsoft Entra suite helps you keep users and organizations safe. It helps you ensure that only the right identities have the right access at the right time. It is available for Microsoft Entra ID P1 and P2 customers and it includes 5 products:
