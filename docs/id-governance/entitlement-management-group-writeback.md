...
#CustomerIntent: As an IT admin, I want to set up group writeback in entitlement management so that I can synchronize cloud-managed groups to on-premises Active Directory.
---
