...
ms.date: 05/13/2025
ms.reviewer: jercon
#CustomerIntent: As an IT admin, I want to use entitlement management and Global Secure Access to restrict employee access to cloud apps so that I can enforce least-privilege access.
---
