...
- Your Attribute Mapping should look like this when the pre-requesites are complete:
    :::image type="content" source="media/entitlement-management-sap-integration/manager-attribute.png" alt-text="Screenshot of attribute mapping for SAP integration." lightbox="media/entitlement-management-sap-integration/sapiagmapping.png":::
