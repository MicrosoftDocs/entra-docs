...
Each step is an [actionStep](/graph/api/resources/tenantgovernanceservices-actionstep?view=graph-rest-beta&preserve-view=true):
...
- **actionUrl**: An [actionUrl](/graph/api/resources/tenantgovernanceservices-actionurl?view=graph-rest-beta&preserve-view=true) that identifies the follow-on Microsoft Graph or Azure Resource Manager (ARM) API to call:
...
- [actionStep resource type](/graph/api/resources/tenantgovernanceservices-actionstep?view=graph-rest-beta&preserve-view=true)
- [actionUrl resource type](/graph/api/resources/tenantgovernanceservices-actionurl?view=graph-rest-beta&preserve-view=true)
