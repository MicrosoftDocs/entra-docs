...
B2B collaboration signals identify tenant relationships based on cross-tenant identity interactions, such as guest user registrations and sign-in activity.
