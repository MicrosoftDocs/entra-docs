...
1. Open a supported admin portal URL, appended with the domain or tenant ID of the governed tenant. For a list of supported portals and workloads, see [GDAP supported workloads](/partner-center/customers/gdap-supported-workloads). For example:

   `https://entra.microsoft.com/{governed-tenant-domain-or-id}`

1. Sign in with your governing tenant credentials.

1. After successful sign-in, you can perform administrative tasks in the governed tenant based on the roles assigned to your security group.
