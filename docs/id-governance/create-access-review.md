...
1. In the **Advanced settings** section, you can choose the following:
    ...
    - **Access Review Agent**: Select this checkbox to allow reviewers to complete the access review in Microsoft Teams with natural language, insights, and recommendations.
    > [!NOTE]
