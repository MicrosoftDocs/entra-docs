...
ms.topic: tutorial
ms.date: 04/11/2025
#Customer Intent: As an IT admin, I want to create custom entitlement reports using application data from multiple sources so that I can gain comprehensive visibility into access across my organization.
---
