...
Customers may want to configure PIM using Global Secure Access for these reasons:

**Enhanced Security:** PIM allows for just-in-time privileged access, reducing the risk of excessive, unnecessary, or misused access permissions within your environment. This aligns with the Zero Trust principle of least privilege, ensuring that users have access only when they need it.
...
1. Navigate to [Microsoft Entra](https://entra.microsoft.com/) > **Identity** > **Groups** > **All groups**.
   ...
   :::image type="content" border="true" source="./media/all-groups.png" alt-text="Screenshot of the All groups screen.":::
...
1. Select **Create**. 
   ...
   :::image type="content" border="true" source="./media/new-group.png" alt-text="Screenshot of the New group screen.":::
...
1. Select **Groups**, then **Discover groups**. 
   ...
   :::image type="content" border="true" source="./media/discover-groups.png" alt-text="Screenshot of the Groups screen with Discover groups selected.":::
...
1. When prompted for onboarding, select **OK**. 
    ...
    :::image type="content" border="true" source="./media/manage-groups.png" alt-text="Screenshot of the Manage groups screen with a group selected.":::

### Configure customer role (optional step)

1. Select **Setting**, then select **Member**. 

   :::image type="content" border="true" source="./media/choose-member-role.png" alt-text="Screenshot of Member Role screen.":::
...
1. In the **On activation** option, require **Azure MFA**, and select **Update**.
   ...
   :::image type="content" border="true" source="./media/activation-tab.png" alt-text="Screenshot of the Activation tab options.":::

### Assign eligible membership

1. Select **Assignments**, then **Add assignments**. 

   :::image type="content" border="true" source="./media/add-asignments.png" alt-text="Screenshot of the Add assignments option.":::

1. In the **Role** option, select **Member**, then click **Next**.
1. Add the selected member(s) that you would like to include for the role.
 
   :::image type="content" border="true" source="./media/eligible-assignment.png" alt-text="Screenshot of the eligible member.":::

1. In the **Assignment Type** option, select **Eligible**, then click **Assign**.

   :::image type="content" border="true" source="./media/eligible-member.png" alt-text="Screenshot of the Eligible member screen.":::
...
1. Select **Add user/group**, then specify the group that you created; for example `HighRiskAssetAccess`.  
   ...
   :::image type="content" border="true" source="./media/quick-access.png" alt-text="Screenshot of the Quick Access screen.":::
...
:::image type="content" border="true" source="./media/client-experience.png" alt-text="Screenshot of the client experience error message.":::

## Step 2: Activate privileged access

Next, we activate the PIM role using the Microsoft Entra portal, and then attempt to connect with the new role activated.
...
1. Select **My roles** and select **Groups** to see all eligible assignments.
   ...
   :::image type="content" border="true" source="./media/my-roles-groups.png" alt-text="Screenshot of My role groups screen.":::
...
1. Select **Activate**, then type the reason in the **Reason** box. You can also choose to adjust the parameters of the session, then select **Activate**.
   ...
   :::image type="content" border="true" source="./media/activate-member.png" alt-text="Screenshot of the Activate member screen.":::

1. Once the role is activated, you receive a confirmation from the portal.

   :::image type="content" border="true" source="./media/member-activated.png" alt-text="Screenshot of the member being activated im the portal.":::
...
- Browse any of the published resources, as you should be able to successfully connect to them. 
   ...
   :::image type="content" border="true" source="./media/identify-remote-computer.png" alt-text="Screenshot of connecting to published resource.":::
...
:::image type="content" border="true" source="./media/deactivate-member.png" alt-text="Screenshot of Deactiviate member screen.":::

1. A confirmation is sent to you once the role has been deactivated.  
...
:::image type="content" border="true" source="./media/audit-log-details.png" alt-text="Screenshot of the Audit log details screen.":::
