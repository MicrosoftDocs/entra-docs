...
:::image type="content" source="./media/pim-getting-started/pim-quickstart-tasks.png" alt-text="Navigation window in Privileged Identity Management showing Tasks and Manage options":::
