...
:::image type="content" source="./media/pim-email-notifications/email-directory-new.png" alt-text="New Privileged Identity Management email for Microsoft Entra roles":::
...
:::image type="content" source="./media/pim-email-notifications/email-directory-weekly.png" alt-text="Weekly Privileged Identity Management digest email for Microsoft Entra roles":::
...
:::image type="content" source="./media/pim-email-notifications/email-resources-new.png" alt-text="New Privileged Identity Management email for Azure resource roles":::
