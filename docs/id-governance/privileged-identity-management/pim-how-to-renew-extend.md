...
:::image type="content" source="./media/pim-how-to-renew-extend/pim-extend-within-fourteen.png" alt-text="Action column with links to Activate or Extend":::

To request an extension of this role assignment, select **Extend** to open the request form.

:::image type="content" source="./media/pim-how-to-renew-extend/extend-role-assignment-request.png" alt-text="Extend role assignment pane with a Reason box":::
...
:::image type="content" source="./media/pim-how-to-renew-extend/extend-notification.png" alt-text="Notification explaining that there is already an existing pending role assignment extension":::

Go to the **Pending requests** page to view the status of your request or to cancel it.

:::image type="content" source="./media/pim-how-to-renew-extend/pending-requests.png" alt-text="Microsoft Entra roles - Pending requests page listing any pending requested and a link to Cancel":::
...
:::image type="content" source="./media/pim-how-to-renew-extend/extend-admin-approve-list.png" alt-text="Microsoft Entra roles - Approve requests page listing requests and links to approve or deny":::
...
:::image type="content" source="./media/pim-how-to-renew-extend/extend-admin-approve-form.png" alt-text="Approve role assignment request with requestor reason, assignment type, start time, end time, and reason":::
...
:::image type="content" source="./media/pim-how-to-renew-extend/extend-admin-extend.png" alt-text="Microsoft Entra roles - Assignments page listing eligible roles with links to extend":::
...
:::image type="content" source="./media/pim-how-to-renew-extend/renew-from-myroles.png" alt-text="My roles page - Expired roles tab":::
...
:::image type="content" source="./media/pim-how-to-renew-extend/renew-request-form.png" alt-text="Renew role assignment pane showing Reason box":::
...
:::image type="content" source="./media/pim-how-to-renew-extend/renew-from-assignments-pane.png" alt-text="Microsoft Entra roles - Assignments page listing expired roles with links to renew":::
