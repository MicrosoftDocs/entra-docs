...
1. Select a role you want to assign, select a member to whom you want to assign to the role, and then select **Next**.
    ...
    You can select users, groups, or agent identities. For a list of roles that you can assign to agent identities, see **Authorization in Microsoft Entra Agent ID**.
