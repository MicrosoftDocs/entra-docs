...
#CustomerIntent: As an IT admin, I want to understand what access reviews are and when to use them so that I can manage group memberships, application access, and role assignments effectively.
---
