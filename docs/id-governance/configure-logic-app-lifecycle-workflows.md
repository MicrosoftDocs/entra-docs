...
#CustomerIntent: As an IT admin, I want to configure an Azure Logic App for use with lifecycle workflows so that I can extend workflow automation capabilities.
---
