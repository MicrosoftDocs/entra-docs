...
1. Select **Details** to see details about the access request.
    ...
    The details include the identities name, organization, access start and end date if provided, business justification, when the request was submitted, and when the request expires.
...
3. Select **Remove** to remove the identities access to the access package. Include a reason for why you're revoking your decision.
