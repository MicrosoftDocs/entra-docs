...
#Customer Intent: As an IT admin, I want to configure ID Protection-based approvals for access package requests so that I can ensure risky users are reviewed before gaining access to sensitive resources.
---
