...
|[Privileged Identity Management (PIM)](/id-governance/privileged-identity-management/pim-configure)|||x|x|
|[PIM For Groups](/privileged-identity-management/concept-pim-for-groups)|||x|x|
|[PIM CA Controls](/privileged-identity-management/pim-configure)|||x|x|
