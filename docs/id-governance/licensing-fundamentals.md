...
|[Privileged Identity Management (PIM)](/docs/id-governance/privileged-identity-management/pim-configure.md)|||x|x|
|[PIM For Groups](/docs/id-governance/privileged-identity-management/concept-pim-for-groups.md)|||x|x|
|[PIM CA Controls](/docs/id-governance/privileged-identity-management/pim-configure.md)|||x|x|
