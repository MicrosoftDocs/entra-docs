...
|[Privileged Identity Management (PIM)](~/id-governance/privileged-identity-management/pim-configure.md)|||x|x|
|[PIM For Groups](~/id-governance/privileged-identity-management/concept-pim-for-groups.md)|||x|x|
|[PIM CA Controls](~/id-governance/privileged-identity-management/pim-configure.md)|||x|x|
