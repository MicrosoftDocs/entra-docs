...
#Customer Intent: As an IT admin, I want to configure Verified ID settings for an access package so that I can require identity verification for access requests.
---
