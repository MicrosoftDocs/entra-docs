...
#CustomerIntent: As an IT admin, I want to integrate entitlement management with Microsoft Teams using custom extensibility and Logic Apps so that I can automate Teams-based access management.
---
