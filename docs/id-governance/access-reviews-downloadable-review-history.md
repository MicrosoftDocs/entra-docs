...
ms.topic: how-to
ms.date: 03/12/2026
#Customer Intent: As an IT admin, I want to create and manage downloadable access review history reports so that I can gain insight into the decisions made during access reviews in my organization.
---
