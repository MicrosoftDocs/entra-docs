...
#CustomerIntent: As an IT admin, I want to execute employee termination tasks using lifecycle workflows so that I can automate offboarding on an employee's last day of work.
---
