...
ms.topic: how-to
ms.date: 03/12/2026
#Customer Intent: As an IT admin, I want to review and remove external users who no longer need access to my organization's resources so that I can maintain security and governance compliance.
---
