...
#Customer Intent: As an IT admin, I want to check which users fall into the execution scope of a lifecycle workflow so that I can verify the workflow targets the correct users.
---
