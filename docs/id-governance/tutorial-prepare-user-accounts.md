...
#Customer Intent: As an IT admin, I want to prepare user accounts for lifecycle workflows so that I can ensure the required user attributes are properly configured.
---
