...
#Customer Intent: As an IT admin, I want to manage user access with access reviews so that I can ensure users have appropriate access to groups and applications.
---
