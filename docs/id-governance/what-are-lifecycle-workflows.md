...
- **Automating dynamic membership groups**: When groups in your organization are well defined, you can automate user membership in those groups. Benefits and differences from dynamic membership groups include:
  ...
  - Lifecycle workflows help manage users' lifecycle beyond attributes supported in dynamic membership groups--for example, a certain number of days before the `employeeHireDate` attribute value.
