...
To remove the passkey from Authenticator, tap the account name, and tap **Settings** > **Delete passkey**. You also need to delete your passkey from [Security info](https://mysignins.microsoft.com/security-info).
