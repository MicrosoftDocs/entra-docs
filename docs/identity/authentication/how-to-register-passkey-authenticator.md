...
1. Select **Passkey in Microsoft Authenticator (preview)** and then click **Add**.
...
1. After signing-in withmultifactor authentication (MFA) you can continue through the rest of the passkey setup.
   ...
   1. Your device will open a security window. Save the passkey to Authenticator following the prompts on your device. 
   ...
   1. Once the passkey is successsfully created on your device you'll be directed back to My Security-Info, tap **Done**. 
   ...
   1. You can now see the Microsoft Authenticator managed passkey along with your other registered security-info.
...
1. Open your system camera application on your device and navigate back to My security-info. 
...
2.  Chooose **iPhone, iPad, or Android device** and tap **Next**.   
...
1. After signing-in withmultifactor authentication (MFA) you can continue through the rest of the passkey setup.
   ...
   1. Once the passkey is successsfully created on your device you'll be directed back to My Security-Info.
...
3.  Chooose **iPhone, iPad, or Android device** and tap **Next**.   
...
- If the a passkey for your account is already registered in Microsoft authenticator you will receive the following error: 
