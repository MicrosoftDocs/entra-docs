...
* [Check if TLS 1.2 is enabled](#check-if-tls-12-is-enabled)
* [Make sure Microsoft .NET Framework 4.8 or higher is enabled (Sync Server)](#make-sure-microsoft-net-framework-48-or-higher-is-enabled-sync-server)
