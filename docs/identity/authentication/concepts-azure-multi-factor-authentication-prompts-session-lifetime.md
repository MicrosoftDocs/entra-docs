...
To review token lifetimes, [use Azure AD PowerShell to query any Microsoft Entra policies](~/identity-platform/configure-token-lifetimes.yml#get-started). Disable any policies that you have in place.
