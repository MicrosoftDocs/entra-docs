...
|   Category           | Microsoft 365 apps and Microsoft Entra ID Free | Microsoft Entra ID P1 or P2 |
|------------------------------|-----------------------------------|------------------|
