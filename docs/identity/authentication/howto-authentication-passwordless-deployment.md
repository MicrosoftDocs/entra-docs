...
* [FIDO2-compliant security keys](./concept-authentication-passwordless.md#fido2-security-key-providerss) - useful for users who sign in to shared machines like kiosks, in situations where use of phones is restricted, and for highly privileged identities. 
