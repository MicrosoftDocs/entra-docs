...
>
> You can also [force users to re-register authentication methods](howto-mfa-userdevicesettings.yml#manage-user-authentication-options) if they previously only enabled SSPR.
>
