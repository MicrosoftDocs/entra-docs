...
SSPR will honor browser language setting. When there is customization for browser language, the page will display in browser language customization. Otherwise,it falls to default locale cusotmization.
