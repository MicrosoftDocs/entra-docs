---
title: Overview of Microsoft Entra ID self-service account recovery (SSAR)
description: Overview of Microsoft Entra ID self-service account recovery.
ms.service: entra-id
...
---
# Overview of Microsoft Entra ID self-service account recovery (SSAR)
