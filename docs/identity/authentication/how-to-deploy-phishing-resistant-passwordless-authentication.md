...
-------------|----------------------------------|-----------------------------|--------------------------------|--------------------------------|----------------------
Admins and Highly Regulated workers | Windows Hello for Business, Microsoft Entra passkeys on Windows (preview), or CBA | Platform SSO Secure Enclave Key or CBA | Passkey in Microsoft Authenticator or CBA | Passkey in Microsoft Authenticator or CBA | N/A (use smart card instead) 
Non-admins | Windows Hello for Business or Microsoft Entra passkeys on Windows (preview) | Platform Single Sign-on (SSO) Secure Enclave Key | Synced passkey | Synced passkey | N/A (use portable credential instead)
...
Microsoft Entra passkeys on Windows (preview) | <!-- TODO: Add guidance for setting up Microsoft Entra passkeys on Windows (preview). Siobhan Power to assist. -->
