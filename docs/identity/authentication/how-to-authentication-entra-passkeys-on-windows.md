...
:::image type="content" source="media/how-to-authentication-entra-passkeys-on-windows/known-issue-usable-auth-method.png" alt-text="Screenshot that shows a registered passkey still listed as a usable authentication method after the tenant removes it from the allow list.":::
