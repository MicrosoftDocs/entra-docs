...
Role assignments that are associated with deleted managed identities are displayed with "Identity not found" when viewed in the portal. [Read more](/azure/role-based-access-control/troubleshooting#symptom---role-assignments-with-identity-not-found).
