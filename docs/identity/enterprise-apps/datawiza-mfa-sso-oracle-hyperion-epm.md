...
1. Sign in to the [Azure portal](https://portal.azure.com) as a [Global Administrator](~/identity/role-based-access-control/permissions-reference.md#global-administrator) role.
