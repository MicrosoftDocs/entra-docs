...
#customer intent: I'm an IT admin, and I want to configure Datawiza Access Proxy (DAP) to enable single sign-on (SSO) and Microsoft Entra multifactor authentication (MFA) for Outlook Web Access. My goal is to enhance application security while solving issues with legacy-app and modern-SSO integration.
---
