...
:::image type="content" source="media/home-realm-discovery-policy/domainConfDialogNew.png" alt-text="Screenshot of the domain confirmation dialog listing the sign-in identifier '<jane@contoso.com>' with a tenant domain of 'contoso.com'.":::
