...
- Know how to spot and block common consent phishing tactics:
  ...
  - Investigate and hunt for consent phishing attacks by following the guidance on [advanced hunting with Microsoft Defender XDR](/microsoft-365/security/defender/advanced-hunting-overview).
