...
- Run [access reviews of groups and applications](~/id-governance/create-access-review.md) to confirm that service principals and other principals still need their assignments. Access reviews require Microsoft Entra ID P2 or Microsoft Entra ID Governance; for details, see [License requirements](~/id-governance/access-reviews-overview.md#license-requirements).
