...
[Intune](/intune/role-based-access-control) | Views user, device, enrollment, configuration, and application information<br>Maps to the [Intune Endpoint Security Manager Role](/mem/intune/fundamentals/role-based-access-control-reference#endpoint-security-manager)
