...
Grants the ability to delete app registrations regardless of subtype including both single-tenant and multi-tenant applications.
...
Grants the ability to read all properties of single-tenant and multi-tenant applications outside of properties that cannot be read in any situation like credentials.
