...
| [&lt;Custom role&gt;](/entra/identity/role-based-access-control/custom-create) | Can perform actions that apply to users, groups, or devices, according to the definition of the custom role. |
