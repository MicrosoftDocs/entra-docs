...
| [Privileged Authentication Administrator](permissions-reference.md#password-administrator) | Can access to view, set and reset authentication method information for any user (admin or non-admin). |
