...
Metaverse objects can't be manually created or deleted. The sync engine automatically deletes metaverse objects that don't have a link to any connector space object in the connector space.
