...
This topic covers the basic architecture for Microsoft Entra Connect Sync. If you are familiar with earlier identity synchronziation technologies, the content of this topic will be familiar to you as well. If you are new to synchronization, then this topic is for you. It is however not a requirement to know the details of this topic to be successful in making customizations to Microsoft Entra Connect Sync (called sync engine in this topic).
