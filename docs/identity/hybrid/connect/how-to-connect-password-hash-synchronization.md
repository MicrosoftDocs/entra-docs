...
> 1.	Perform a full PHS sync as per [this guide](tshoot-connect-password-hash-synchronization?WT.mc_id=ITOPSTALK-blog-abartolo#trigger-a-full-sync-of-all-passwords.md) to ensure password of SCRIL users is scrambled
