...
The previous versions of Microsoft Entra Connect shipped with the ADAL authentication library. This library is deprecated as of December 2022. The V2 release ships with the newer MSAL library. For more information, see [Overview of the MSAL library](~/identity-platform/msal-overview.md).
...
> 
>All versions of [Windows Server support TLS 1.2](/windows-server/security/tls/tls-ssl-schannel-ssp-overview). If TLS 1.2 is not enabled on your server, you need to enable this before you can deploy Microsoft Entra Connect V2.0.
>
...
You should upgrade to Microsoft Entra Connect V2 as soon as you can. **__All Azure AD Connect V1 versions are retired on 31 August, 2022.__** For now, we'll continue to support older versions of Microsoft Entra Connect. However, it may prove difficult to provide a good support experience if some of the components in Microsoft Entra Connect have dropped out of support. This upgrade is particularly important for ADAL and TLS1.0/1.1 as these services might stop working unexpectedly after they're deprecated. 
