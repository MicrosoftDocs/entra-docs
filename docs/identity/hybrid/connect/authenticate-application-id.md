...
|**Provider name**|Specifies the key storage provider: `Microsoft Software Key Storage Provider` for software certificates, or `Microsoft Platform Crypto Provider` for TPM-based certificates |
