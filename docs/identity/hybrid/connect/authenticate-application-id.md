...
:::image type="content" source="media/authenticate-application-id/auth-8.png" alt-text="Screenshot that shows the client ID." lightbox="media/authenticate-application-id/auth-8.png":::
...
:::image type="content" source="media/authenticate-application-id/auth-9.png" alt-text="Screenshot that shows the account name." lightbox="media/authenticate-application-id/auth-9.png":::
