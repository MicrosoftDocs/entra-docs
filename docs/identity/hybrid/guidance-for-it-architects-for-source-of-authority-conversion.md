...
:::image type="complex" source="media/guidance-for-it-architects-for-source-of-authority-conversion/source-of-authority-readiness-diagram.svg" alt-text="Source of authority readiness diagram. IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.IF-ELSE statement for diagram.":::
...
- **Kerberos-based Apps** (Windows Integrated Authentication, intranet web apps, file shares)
  ...
  - **Requirements:**
    ...
    - Microsoft Entra ID P1/P2 or Suite licenses
    - AD account for user (synced or provisioned)
  - **Considerations:**
    - Seamless SSO using Microsoft Entra ID credentials
    - Password-less and phish-resistant methods for Kerberos apps
...
- **LDAP-based Apps** (Apps that bind to AD DS over LDAP for auth/queries)
  ...
  - **Requirements:**
    ...
    - Users/groups must be in Microsoft Entra ID (synced to Microsoft Entra ID DS)
    - Might require password reset to generate hashes
  - **Considerations:**
