...
1. Search the Exchange or Exchange Online logs to see if mail was sent to the group. You can use Get-MessageTrackingLog to search and analyze the logs. If mail was sent, then the group is likely still in use. Contact the senders of those mails to determine the purpose of the group.
