...
- Microsoft Entra Cloud Sync agent must be installed on a domain-joined server that runs Windows Server 2025 or Windows Server 2022. We recommend Windows Server 2025 or Windows Server 2022. Older versions of Windows Server (Windows Server 2019, Windows Server 2016) are in extended support and might require [a paid support program](/lifecycle/policies/fixed#extended-support) if you require support for this configuration. Installing on unsupported versions of Windows Server may cause service failures or unexpected behavior.
...
- A domain-joined server that runs Windows Server 2025 or Windows Server 2022 for the agent installation.
...
1. Identify a domain-joined host server that runs Windows Server 2025 or Windows Server 2022 with a minimum of 4-GB RAM and .NET 4.7.1+ runtime.
