...
- Follow the [Monitor changes to federation configuration](~/identity/connect/how-to-connect-monitor-federation-changes.md) to set up alerts to monitor changes to the trust established between your Idp and Microsoft Entra ID. 
