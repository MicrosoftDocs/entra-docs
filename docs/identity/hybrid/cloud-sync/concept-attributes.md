...
Each cloud sync configuration includes a [synchronization schema](/graph/api/resources/synchronization-synchronizationschema?view=graph-rest-1.0). This synchronization schema defines what objects will be synchronized and how they are synchronized.
