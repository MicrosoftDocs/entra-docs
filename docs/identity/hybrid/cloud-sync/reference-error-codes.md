...
To find groups in Active Directory that have same value starting with "Group_" in the attribute *msDS-ExternalDirectoryObjectId*, run the following PowerShell script:
