...
1. In the **Tenant URL** field, input your InviteDesk Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to InviteDesk. If the connection fails, ensure your InviteDesk account has the required admin permissions and try again.
