---
title: Configure hCaptcha Enterprise for Single sign-on with Microsoft Entra ID
...
# Configure hCaptcha Enterprise for Single sign-on with Microsoft Entra ID
...
hCaptcha Enterprise is available in the following [national cloud deployments](/graph/deployments).
