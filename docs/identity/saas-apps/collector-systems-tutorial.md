...
1. **[Configure Collector Systems SSO](#configure-collector-systems-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Collector Systems test user](#create-collector-systems-test-user)** - to have a counterpart of B.Simon in Collector Systems that is linked to the Microsoft Entra ID representation of user.
