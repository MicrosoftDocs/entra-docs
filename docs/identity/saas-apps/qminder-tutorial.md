...
In this tutorial, you'll learn how to integrate Qminder with Microsoft Entra ID. When you integrate Qminder with Microsoft Entra ID, you can:
...
To integrate Microsoft Entra ID with Qminder, you need:
