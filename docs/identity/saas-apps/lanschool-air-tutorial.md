---
title: Microsoft Entra single sign-on (SSO) integration with LanSchool Air
...
# Microsoft Entra single sign-on (SSO) integration with LanSchool Air

In this article,  you'll learn how to integrate LanSchool Air with Microsoft Entra ID. When you integrate LanSchool Air with Microsoft Entra ID, you can:
