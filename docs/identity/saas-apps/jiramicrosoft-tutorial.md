...
- JIRA Core and Software 7.0 to 10.4.1 or JIRA Service Desk 3.0 to 5.12.18 should be installed and configured on Windows 64-bit version.
...
* JIRA Core and Software: 7.0 to 10.4.1.
* JIRA Service Desk 3.0 to 5.12.18.
