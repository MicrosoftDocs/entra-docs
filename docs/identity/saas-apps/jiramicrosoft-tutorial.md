...
- JIRA Core and Software 7.0 to 9.17.5 or JIRA Service Desk 3.0 to 5.17.5 should be installed and configured on Windows 64-bit version.
...
* JIRA Service Desk 3.0 to 5.17.5.
