...
1. In the **Tenant URL** field, enter your Island Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Island. If the connection fails, ensure your Island account has the required admin permissions and try again.
