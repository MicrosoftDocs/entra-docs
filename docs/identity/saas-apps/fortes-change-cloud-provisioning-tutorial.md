...
# Configure Fortes Change Cloud for automatic user provisioning with Microsoft Entra ID
...
1. In the **Tenant URL** field, input your Fortes Change Cloud Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Fortes Change Cloud. If the connection fails, ensure your Fortes Change Cloud account has the required admin permissions and try again.
