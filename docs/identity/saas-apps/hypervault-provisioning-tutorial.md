...
1. In the **Tenant URL** field, enter your Hypervault Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Hypervault. If the connection fails, ensure your Hypervault account has the required admin permissions and try again.
