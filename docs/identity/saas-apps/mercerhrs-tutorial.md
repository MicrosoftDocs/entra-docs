---
title: Configure Mercer BenefitsCentral (MBC) for Single sign-on with Microsoft Entra ID
...
---
# Configure Mercer BenefitsCentral (MBC) for Single sign-on with Microsoft Entra ID
