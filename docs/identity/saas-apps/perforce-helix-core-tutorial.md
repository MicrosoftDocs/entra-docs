---
title: Configure Perforce Helix Core - Helix Authentication Service for Single sign-on with Microsoft Entra ID
...
# Configure Perforce Helix Core - Helix Authentication Service for Single sign-on with Microsoft Entra ID

In this article,  you learn how to integrate Perforce Helix Core - Helix Authentication Service with Microsoft Entra ID. When you integrate Perforce Helix Core - Helix Authentication Service with Microsoft Entra ID, you can:
...
Perforce Helix Core - Helix Authentication Service is available in the following [national cloud deployments](/graph/deployments).
...
1. **[Configure Perforce Helix Core - Helix Authentication Service SSO](#configure-perforce-helix-core---helix-authentication-service-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Perforce Helix Core - Helix Authentication Service test user](#create-perforce-helix-core---helix-authentication-service-test-user)** - to have a counterpart of B.Simon in Perforce Helix Core - Helix Authentication Service that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **Perforce Helix Core - Helix Authentication Service** > **Single sign-on**.
...
* Select **Test this application**, this option redirects to Perforce Helix Core - Helix Authentication Service Sign-on URL where you can initiate the login flow. 

* Go to Perforce Helix Core - Helix Authentication Service Sign-on URL directly and initiate the login flow from there.

* You can use Microsoft My Apps. When you select the Perforce Helix Core - Helix Authentication Service tile in the My Apps, this option redirects to Perforce Helix Core - Helix Authentication Service Sign-on URL. For more information about the My Apps, see [Introduction to the My Apps](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
