...
1. In the **Tenant URL** field, enter your YardiOne Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to YardiOne. If the connection fails, ensure your YardiOne account has the required admin permissions and try again.
