...
1. **[Configure vonage SSO](#configure-vonage-sso)** - to configure the single sign-on settings on application side.
    1. **[Create vonage test user](#create-vonage-test-user)** - to have a counterpart of B.Simon in vonage that's linked to the Microsoft Entra representation of user.
...
* Select **Test this application** in Azure portal. this option redirects to vonage Sign on URL where you can initiate the login flow.  
