...
### Configure automatic user provisioning for Servicely in Microsoft Entra ID
...
1. In the **Tenant URL** field, enter your Servicely Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Servicely. If the connection fails, ensure your Servicely account has the required admin permissions and try again.
