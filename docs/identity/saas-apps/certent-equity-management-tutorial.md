---
title: Configure Certent Equity Management for Single sign-on with Microsoft Entra ID
...
# Configure Certent Equity Management for Single sign-on with Microsoft Entra ID
