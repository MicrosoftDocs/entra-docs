...
1. In the **Tenant URL** field, input your Vbrick Rev Cloud Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Vbrick Rev Cloud. If the connection fails, ensure your Vbrick Rev Cloud account has the required admin permissions and try again.
