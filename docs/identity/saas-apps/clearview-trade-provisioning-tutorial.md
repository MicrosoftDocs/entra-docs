...
1. In the **Tenant URL** field, input your ClearView Trade Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to ClearView Trade. If the connection fails, ensure your ClearView Trade account has the required admin permissions and try again.
