...
In this article,  you'll learn how to integrate BC in the Cloud with Microsoft Entra ID. When you integrate BC in the Cloud with Microsoft Entra ID, you can:
