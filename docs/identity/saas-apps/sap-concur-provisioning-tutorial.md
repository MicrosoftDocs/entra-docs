---
title: Automate User provisioning into SAP Concur with Microsoft Entra ID
...
# Configure Microsoft Entra ID and SAP Cloud Identity Services for automatic user provisioning into SAP Concur
