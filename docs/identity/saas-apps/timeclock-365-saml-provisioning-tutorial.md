...
1. In the applications list, select **TimeClock 365 SAML**.
	...
	![Screenshot of TimeClock 365 SAML link in the Applications list.](common/all-applications.png)
...
1. In the **Tenant URL** field, enter your TimeClock 365 SAML Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to TimeClock 365 SAML. If the connection fails, ensure your TimeClock 365 SAML account has the required admin permissions and try again.
