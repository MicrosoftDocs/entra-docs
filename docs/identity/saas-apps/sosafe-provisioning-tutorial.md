...
1. In the **Tenant URL** field, input your SoSafe Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to SoSafe. If the connection fails, ensure your SoSafe account has the required admin permissions and try again.
