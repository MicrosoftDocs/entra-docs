...
1. In the **Tenant URL** field, input your Zero Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Zero. If the connection fails, ensure your Zero account has the required admin permissions and try again.
