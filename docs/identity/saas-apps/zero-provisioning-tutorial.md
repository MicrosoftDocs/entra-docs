...
1. In the **Tenant URL** field, enter your Zero tenant URL and secret token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Zero. If the connection fails, ensure your Zero account has the required admin permissions and try again.
