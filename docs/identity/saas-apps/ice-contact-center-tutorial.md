---
title: Configure ice Contact Center for Single sign-on with Microsoft Entra ID
...
# Configure ice Contact Center for Single sign-on with Microsoft Entra ID

In this article,  you learn how to integrate ice Contact Center with Microsoft Entra ID. When you integrate ice Contact Center with Microsoft Entra ID, you can:
...
ice Contact Center is available in the following [national cloud deployments](/graph/deployments).
...
1. **[Configure ice Contact Center SSO](#configure-ice-contact-center-sso)** - to configure the single sign-on settings on application side.
    1. **[Create ice Contact Center test user](#create-ice-contact-center-test-user)** - to have a counterpart of B.Simon in ice Contact Center that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **ice Contact Center** > **Single sign-on**.
...
1. On the **Basic SAML Configuration** section, perform the following steps:
	...
	> [!NOTE]
	> These values aren't real. Update these values with the actual Identifier,Reply URL and Sign on URL. Contact [ice Contact Center Client support team](mailto:support@computer-talk.com) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section.
...
* Select **Test this application**, this option redirects to ice Contact Center Sign-on URL where you can initiate the login flow. 

* Go to ice Contact Center Sign-on URL directly and initiate the login flow from there.

* You can use Microsoft My Apps. When you select the ice Contact Center tile in the My Apps, this option redirects to ice Contact Center Sign-on URL. For more information about the My Apps, see [Introduction to the My Apps](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
