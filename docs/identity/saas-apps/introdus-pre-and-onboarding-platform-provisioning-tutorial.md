...
1. In the **Tenant URL** field, input your introDus Pre and Onboarding Platform Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to introDus Pre and Onboarding Platform. If the connection fails, ensure your introDus Pre and Onboarding Platform account has the required admin permissions and try again.
