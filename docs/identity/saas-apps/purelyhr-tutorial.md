---
title: Microsoft Entra single sign-on (SSO) integration with PurelyHR
...
# Microsoft Entra single sign-on (SSO) integration with PurelyHR

In this article,  you'll learn how to integrate PurelyHR with Microsoft Entra ID. When you integrate PurelyHR with Microsoft Entra ID, you can:
