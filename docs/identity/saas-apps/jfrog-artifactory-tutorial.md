...
To integrate Microsoft Entra ID with JFrog Artifactory, you need:
...
In this section, you'll enable B.Simon to use Microsoft Entra single sign-on by granting access to JFrog Artifactory.
