...
1. Use [on-demand provisioning](~/identity/app-provisioning/provision-on-demand.md) to validate sync witha few users before deploying more broadly in your organization.  
