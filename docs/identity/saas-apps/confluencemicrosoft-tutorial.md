...
> [!WARNING]
> **Deprecation notice:** This plugin was deprecated on May 1, 2026. To continue setting up single sign-on for Confluence, use a supported replacement from [Atlassian Marketplace](https://marketplace.atlassian.com/search?product=Confluence&query=sso).
