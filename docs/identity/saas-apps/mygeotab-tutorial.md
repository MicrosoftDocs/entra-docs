...
In this tutorial, you'll learn how to integrate MyGeotab with Microsoft Entra ID. When you integrate MyGeotab with Microsoft Entra ID, you can:
...
To integrate Microsoft Entra ID with MyGeotab, you need:
...
1. **[Configure MyGeotab SSO](#configure-mygeotab-sso)** - to configure the single sign-on settings on application side.
    1. **[Create MyGeotab test user](#create-mygeotab-test-user)** - to have a counterpart of B.Simon in MyGeotab that is linked to the Microsoft Entra ID representation of user.
