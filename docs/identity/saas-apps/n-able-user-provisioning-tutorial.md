...
1. Sign in to the [Microsoft Entra admin center]( https://portal.azure.com/?feature.userProvisioningV2Authentication=true) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
