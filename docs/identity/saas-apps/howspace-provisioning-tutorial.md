...
1. In the **Tenant URL** field, enter your Howspace Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Howspace. If the connection fails, ensure your Howspace account has the required admin permissions and try again.
