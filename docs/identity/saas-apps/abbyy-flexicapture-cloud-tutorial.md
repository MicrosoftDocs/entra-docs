---
title: Configure ABBYY FlexiCapture Cloud for Single sign-on with Microsoft Entra ID
...
# Configure ABBYY FlexiCapture Cloud for Single sign-on with Microsoft Entra ID
