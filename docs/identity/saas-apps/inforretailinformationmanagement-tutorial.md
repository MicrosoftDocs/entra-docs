---
title: 'Tutorial: Microsoft Entra integration with Infor Retail – Information Management'
...
---
# Tutorial: Microsoft Entra integration with Infor Retail – Information Management

In this tutorial, you'll learn how to integrate Infor Retail – Information Management with Microsoft Entra ID. When you integrate Infor Retail – Information Management with Microsoft Entra ID, you can:
...
To configure Microsoft Entra integration with Infor Retail – Information Management, you need the following items:
...
1. **[Configure Infor Retail Information Management SSO](#configure-infor-retail-information-management-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Infor Retail Information Management test user](#create-infor-retail-information-management-test-user)** - to have a counterpart of B.Simon in Infor Retail – Information Management that is linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Identity** > **Applications** > **Enterprise applications** > **Infor Retail – Information Management** > **Single sign-on**.
...
5. Click **Set additional URLs** and perform the following step if you wish to configure the application in **SP** initiated mode:
	...
	> [!NOTE]
	> These values are not real. Update these values with the actual Identifier, Reply URL and Sign-on URL. Contact [Infor Retail – Information Management Client support team](mailto:innovate@infor.com) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section.
...
In this section, you'll enable B.Simon to use single sign-on by granting access to Infor Retail – Information Management.

1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Identity** > **Applications** > **Enterprise applications** > **Infor Retail – Information Management**.
...
* Click on **Test this application**, this will redirect to Infor Retail – Information Management Sign on URL where you can initiate the login flow.  

* Go to Infor Retail – Information Management Sign-on URL directly and initiate the login flow from there.

#### IDP initiated:

* Click on **Test this application**, and you should be automatically signed in to the Infor Retail – Information Management for which you set up the SSO. 

You can also use Microsoft My Apps to test the application in any mode. When you click the Infor Retail – Information Management tile in the My Apps, if configured in SP mode you would be redirected to the application sign on page for initiating the login flow and if configured in IDP mode, you should be automatically signed in to the Infor Retail – Information Management for which you set up the SSO. For more information about the My Apps, see [Introduction to the My Apps](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
