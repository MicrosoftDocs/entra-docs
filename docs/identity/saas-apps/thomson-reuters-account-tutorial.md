...
1. **[Configure Thomson Reuters Account SSO](#configure-thomson-reuters-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Thomson Reuters Account test user](#create-thomson-reuters-test-user)** - to have a counterpart of B.Simon in Thomson Reuters Account that is linked to the Microsoft Entra ID representation of user.
