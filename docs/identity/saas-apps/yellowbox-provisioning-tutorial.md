...
1. In the **Tenant URL** field, enter your Yellowbox Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Yellowbox. If the connection fails, ensure your Yellowbox account has the required admin permissions and try again.
