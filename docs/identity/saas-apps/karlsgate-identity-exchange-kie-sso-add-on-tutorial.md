...
1. A list of one (or more) **email domain(s)** (min. 1) for users who will be accessing the Karlsgate Identity Exchange (KIE) SSO Add-on, e.g., : northwind.com, de.contoso.com, fr.contoso.com, and so on. (See note below.)
