...
# Configure TimeClock 365 for automatic user provisioning with Microsoft Entra ID
...
Add TimeClock 365 from the Microsoft Entra application gallery to start managing provisioning to TimeClock 365. If you have previously setup TimeClock 365 for SSO you can use the same application. However, we recommend that you create a separate app when testing out the integration initially. Learn more about adding an application from the gallery [here](~/identity/enterprise-apps/add-application-portal.md). 
