...
### Configure automatic user provisioning for Zello in Microsoft Entra ID
...
1. In the **Tenant URL** field, enter your Zello Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Zello. If the connection fails, ensure your Zello account has the required admin permissions and try again.
