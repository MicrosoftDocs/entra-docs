...
1. In the **Tenant URL** field, input your Zello Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Zello. If the connection fails, ensure your Zello account has the required admin permissions and try again.
