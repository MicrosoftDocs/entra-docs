---
title: Microsoft Entra single sign-on (SSO) integration with Proto.io
...
# Microsoft Entra single sign-on (SSO) integration with Proto.io

In this article,  you'll learn how to integrate Proto.io with Microsoft Entra ID. When you integrate Proto.io with Microsoft Entra ID, you can:
