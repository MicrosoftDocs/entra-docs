---
title: Configure Smartlook for Single sign-on with Microsoft Entra ID
...
# Configure Smartlook for Single sign-on with Microsoft Entra ID

In this article,  you learn how to integrate Smartlook with Microsoft Entra ID. When you integrate Smartlook with Microsoft Entra ID, you can:
...
1. **[Configure Smartlook SSO](#configure-smartlook-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Smartlook test user](#create-smartlook-test-user)** - to have a counterpart of B.Simon in Smartlook that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **Smartlook** > **Single sign-on**.
...
In this section, a user called Britta Simon is created in Smartlook. Smartlook supports just-in-time user provisioning, which is enabled by default. There's no action item for you in this section. If a user doesn't already exist in Smartlook, a new one is created after authentication.
