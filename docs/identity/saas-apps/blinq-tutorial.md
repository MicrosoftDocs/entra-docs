...
In this tutorial, you'll learn how to integrate Blinq with Microsoft Entra ID. When you integrate Blinq with Microsoft Entra ID, you can:
...
To integrate Microsoft Entra ID with Blinq, you need:
...
1. **[Configure Blinq SSO](#configure-blinq-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Blinq test user](#create-blinq-test-user)** - to have a counterpart of B.Simon in Blinq that is linked to the Microsoft Entra ID representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Identity** > **Applications** > **Enterprise applications** > **Blinq** > **Single sign-on**.
...
1. On the **Basic SAML Configuration** section, perform the following steps:
	...
	> [!NOTE]
	> These values are not real. Update these values with the actual Reply URL and Sign on URL. Contact [Blinq support team](mailto:support@blinq.me) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section in the Microsoft Entra admin center.
...
In this section, you'll enable B.Simon to use Microsoft Entra single sign-on by granting access to Blinq.

1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Identity** > **Applications** > **Enterprise applications** > **Blinq**.
...
1. Go to **Team members** and click **Add team member +**.
...
* Click on **Test this application** in Microsoft Entra admin center. This will redirect to Blinq Sign-on URL where you can initiate the login flow.
 
* Go to Blinq Sign-on URL directly and initiate the login flow from there.
 
* You can use Microsoft My Apps. When you click the Blinq tile in the My Apps, this will redirect to Blinq Sign-on URL. For more information about the My Apps, see [Introduction to the My Apps](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
