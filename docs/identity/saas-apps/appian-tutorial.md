---
title: Microsoft Entra single sign-on (SSO) integration with Appian
...
# Microsoft Entra single sign-on (SSO) integration with Appian

In this article,  you'll learn how to integrate Appian with Microsoft Entra ID. When you integrate Appian with Microsoft Entra ID, you can:
