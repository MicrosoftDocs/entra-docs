...
In this article,  you learn how to integrate iWellnessNow with Microsoft Entra ID. When you integrate iWellnessNow with Microsoft Entra ID, you can:
...
1. **[Configure iWellnessNow SSO](#configure-iwellnessnow-sso)** - to configure the single sign-on settings on application side.
    1. **[Create iWellnessNow test user](#create-iwellnessnow-test-user)** - to have a counterpart of B.Simon in iWellnessNow that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **iWellnessNow** application integration page, find the **Manage** section and select **Single sign-on**.
...
1. Select **Set additional URLs** and perform the following step if you wish to configure the application in **SP** initiated mode:
	...
	> [!NOTE]
    > These values aren't real. Update these values with the actual Identifier, Reply URL and Sign on URL. Contact [iWellnessNow Client support team](mailto:info@iwellnessnow.com) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section.
