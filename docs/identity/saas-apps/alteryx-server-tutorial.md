...
In this article,  you'll learn how to integrate Alteryx Server with Microsoft Entra ID. When you integrate Alteryx Server with Microsoft Entra ID, you can:
