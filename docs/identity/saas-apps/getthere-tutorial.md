---
title: Microsoft Entra single sign-on (SSO) integration with GetThere
...
# Microsoft Entra single sign-on (SSO) integration with GetThere

In this article,  you'll learn how to integrate GetThere with Microsoft Entra ID. When you integrate GetThere with Microsoft Entra ID, you can:
