---
title: Configure ProProfs Training Maker for Single sign-on with Microsoft Entra ID
...
# Configure ProProfs Training Maker for Single sign-on with Microsoft Entra ID

In this article,  you learn how to integrate ProProfs Training Maker with Microsoft Entra ID. When you integrate ProProfs Training Maker with Microsoft Entra ID, you can:
...
1. **[Configure ProProfs Training Maker SSO](#configure-proprofs-training-maker-sso)** - to configure the single sign-on settings on application side.
    1. **[Create ProProfs Training Maker test user](#create-proprofs-training-maker-test-user)** - to have a counterpart of B.Simon in ProProfs Training Maker that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **ProProfs Training Maker** > **Single sign-on**.
...
* Select **Test this application**, and you should be automatically signed in to the ProProfs Training Maker for which you set up the SSO.

* You can use Microsoft My Apps. When you select the ProProfs Training Maker tile in the My Apps, you should be automatically signed in to the ProProfs Training Maker for which you set up the SSO. For more information about the My Apps, see [Introduction to the My Apps](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
