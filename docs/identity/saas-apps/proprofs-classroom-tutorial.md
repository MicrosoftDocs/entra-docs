---
title: Microsoft Entra single sign-on (SSO) integration with ProProfs Training Maker
...
# Microsoft Entra single sign-on (SSO) integration with ProProfs Training Maker
