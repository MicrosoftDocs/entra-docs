---
title: Microsoft Entra single sign-on (SSO) integration with Olfeo SAAS
...
# Microsoft Entra single sign-on (SSO) integration with Olfeo SAAS

In this article,  you'll learn how to integrate Olfeo SAAS with Microsoft Entra ID. When you integrate Olfeo SAAS with Microsoft Entra ID, you can:
