...
# Configure Albert for automatic user provisioning with Microsoft Entra ID
...
> * Remove users in Albert when they don't require access anymore.
...
1. In the **Tenant URL** field, input your Albert Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Albert. If the connection fails, ensure your Albert account has the required admin permissions and try again.
