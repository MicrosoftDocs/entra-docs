---
title: Microsoft Entra single sign-on (SSO) integration with Sigstr
...
# Microsoft Entra single sign-on (SSO) integration with Sigstr

In this article,  you'll learn how to integrate Sigstr with Microsoft Entra ID. When you integrate Sigstr with Microsoft Entra ID, you can:
