...
> [!div class="checklist"]
> * Create users in SAP HANA to enable single sign-on to SAP HANA
> * Remove users in SAP HANA when they do not require access anymore
> * Keep user attributes synchronized between Microsoft Entra ID and SAP HANA
...
* SAP HANA Cloud or SAP HANA Database
...
Microsoft Entra has connectors to SAP ECC, SAP Cloud Identity Services, and SAP SuccessFactors. Provisioning into SAP HANA or other applications requires the users to first be present in Microsoft Entra ID. Once you have users in Microsoft Entra ID, you can provision those users from Microsoft Entra ID to SAP Cloud Identity Services. SAP Cloud Identity Services then provisions the users originating from Microsoft Entra ID that are in the SAP Cloud Identity Directory into the downstream SAP applications, including [`SAP HANA Cloud` and 'SAP HANA Database'](https://help.sap.com/docs/cloud-identity-services/cloud-identity-services/sap-hana-cloud-sap-hana-database-7e2b54ec36344dc1983d5f8a6437b11b) through the SAP cloud connector, and others.
...
## Step 4: Configure provisioning from SAP Cloud Identity Services to SAP HANA

At this step, use SAP Cloud Identity Services Identity Provisioning to configure SAP HANA as a target system, where you can provision users and group members. For SAP HANA Cloud or SAP HANA Database, see the [SAP documentation on provisioning to SAP HANA Cloud or SAP HANA Database](https://help.sap.com/docs/cloud-identity-services/cloud-identity-services/sap-hana-cloud-sap-hana-database-7e2b54ec36344dc1983d5f8a6437b11b). 
