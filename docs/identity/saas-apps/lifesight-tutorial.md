...
In this tutorial, you'll learn how to integrate LifeSight with Microsoft Entra ID. When you integrate LifeSight with Microsoft Entra ID, you can:
...
To integrate Microsoft Entra ID with LifeSight, you need:
