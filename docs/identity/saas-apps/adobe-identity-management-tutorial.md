...
1. On the **Basic SAML Configuration** section, perform the following steps:
	...
	> [!NOTE]
	> The Identifier value is not real. Update the value with the actual Identifier which is obtained in the Admin Admin Console, during the federated directory setup wizard.
