...
1. In the **Tenant URL** field, input your frankli Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to frankli. If the connection fails, ensure your frankli account has the required admin permissions and try again.
