---
title: Configure EasyTerritory for Single sign-on with Microsoft Entra ID
...
---
# Configure EasyTerritory for Single sign-on with Microsoft Entra ID
...
1. In the search box, type **EasyTerritory**, select **EasyTerritory** from result panel then select **Add** button to add the application.
...
5. **[Create EasyTerritory test user](#create-easyterritory-test-user)** - to have a counterpart of Britta Simon in EasyTerritory that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **EasyTerritory** application integration page, select **Single sign-on**.
