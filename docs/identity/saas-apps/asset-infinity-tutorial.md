...
* Select **Test this application** in Microsoft Entra admin center. This redirects to Asset Infinity Sign-on URL where you can initiate the login flow.
 
* Go to Asset Infinity Sign-on URL directly and initiate the login flow from there.
 
* You can use Microsoft My Apps. When you select the Asset Infinity tile in the My Apps, this redirects to Asset Infinity Sign-on URL. For more information about the My Apps, see [Introduction to the My Apps](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
