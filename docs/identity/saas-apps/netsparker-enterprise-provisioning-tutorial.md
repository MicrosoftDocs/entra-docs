...
1. In the **Tenant URL** field, input your Netsparker Enterprise Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Netsparker Enterprise. If the connection fails, ensure your Netsparker Enterprise account has the required admin permissions and try again.
