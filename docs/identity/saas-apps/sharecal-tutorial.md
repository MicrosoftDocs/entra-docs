...
1. **[Configure ShareCal SSO](#configure-sharecal-sso)** - to configure the single sign-on settings on application side.
    1. **[Create ShareCal test user](#create-sharecal-test-user)** - to have a counterpart of B.Simon in ShareCal that is linked to the Microsoft Entra ID representation of user.
