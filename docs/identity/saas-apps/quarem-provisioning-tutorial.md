---
title: 'Tutorial: Configure Quarem for automatic user provisioning with Microsoft Entra ID'
description: Learn how to automatically provision and deprovision user accounts from Microsoft Entra ID to Quarem.

author: twimmers
writer: twimmers
manager: jeedes
ms.assetid: dc4b8c94-0996-4fa0-b91e-af5d0a1b2016
ms.service: entra-id
...
# Tutorial: Configure Quarem for automatic user provisioning
...
> * Remove users in Quarem when they do not require access anymore.
...
1. Under the **Admin Credentials** section, input your Quarem Tenant URL and Secret Token. Click **Test Connection** to ensure Microsoft Entra ID can connect to Quarem. If the connection fails, ensure your Quarem account has Admin permissions and try again.
