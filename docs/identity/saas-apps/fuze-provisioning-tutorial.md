...
1. In the **Tenant URL** field, input your Fuze Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Fuze. If the connection fails, ensure your Fuze account has the required admin permissions and try again.
