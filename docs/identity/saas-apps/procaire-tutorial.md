---
title: Microsoft Entra single sign-on (SSO) integration with Procaire
...
# Microsoft Entra single sign-on (SSO) integration with Procaire

In this article,  you'll learn how to integrate Procaire with Microsoft Entra ID. When you integrate Procaire with Microsoft Entra ID, you can:
