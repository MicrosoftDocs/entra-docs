---
title: Configure Eli Onboarding for Single sign-on with Microsoft Entra ID
...
---
# Configure Eli Onboarding for Single sign-on with Microsoft Entra ID

In this article,  you learn how to integrate Eli Onboarding with Microsoft Entra ID. When you integrate Eli Onboarding with Microsoft Entra ID, you can:
...
1. **[Configure Eli Onboarding SSO](#configure-eli-onboarding-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Eli Onboarding test user](#create-eli-onboarding-test-user)** - to have a counterpart of B.Simon in Eli Onboarding that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **Eli Onboarding** > **Single sign-on**.
...
1. On the **Basic SAML Configuration** section, perform the following steps:
	...
	> [!NOTE]
	> These values aren't real. Update these values with the actual Sign on URL and Identifier. Contact [Eli Onboarding Client support team](mailto:support@geteli.com) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section.
...
* Select **Test this application**, this option redirects to Eli Onboarding Sign-on URL where you can initiate the login flow. 

* Go to Eli Onboarding Sign-on URL directly and initiate the login flow from there.

* You can use Microsoft My Apps. When you select the Eli Onboarding tile in the My Apps, this option redirects to Eli Onboarding Sign-on URL. For more information about the My Apps, see [Introduction to the My Apps](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
