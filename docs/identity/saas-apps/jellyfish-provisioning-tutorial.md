...
1. In the **Tenant URL** field, enter your Jellyfish Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Jellyfish. If the connection fails, ensure your Jellyfish account has the required admin permissions and try again.
