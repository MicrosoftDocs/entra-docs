...
1. In the **Tenant URL** field, input your Airstack Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Airstack. If the connection fails, ensure your Airstack account has the required admin permissions and try again.
