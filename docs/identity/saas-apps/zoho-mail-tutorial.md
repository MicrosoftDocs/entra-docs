---
title: Configure Zoho for Single sign-on with Microsoft Entra ID
...
---
# Configure Zoho for Single sign-on with Microsoft Entra ID
...
1. **[Configure Zoho SSO](#configure-zoho-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Zoho test user](#create-zoho-test-user)** - to have a counterpart of B.Simon in Zoho that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **Zoho** > **Single sign-on**.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **Zoho**.
