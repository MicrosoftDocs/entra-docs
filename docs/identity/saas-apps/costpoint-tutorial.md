...
In this article,  you'll learn how to integrate Costpoint with Microsoft Entra ID. When you integrate Costpoint with Microsoft Entra ID, you can:
...
In this article,  you will configure and test Microsoft Entra SSO in a test environment. 
