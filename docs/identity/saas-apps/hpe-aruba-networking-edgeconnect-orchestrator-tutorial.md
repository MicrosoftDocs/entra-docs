...
1. On the **Basic SAML Configuration** section, perform the following steps:
   ...
   f. Go to the **Basic SAML Configuration** section on Microsoft **Set up single sign-on with SAML** page:
 	...
 	1. Under **Identifier (Entity ID)**, click **Add identifier** link. Paste the ACS URL value on the Identifier field.
         ...
         | **Environment** | **URL** |
         | ---------|---------------|
         | Use this pattern if you are configuring SAML SSO on any of the following three Orchestrator products: a. `HPE Aruba Networking EdgeConnect Cloud Orchestrator`,  b. `HPE Aruba Networking EdgeConnect Service Provider Orchestrator`, c. `HPE Aruba Networking EdgeConnect Global Enterprise Orchestrator` |  `https://<SUBDOMAIN>.silverpeak.cloud/gms/rest/authentication/saml2/consume` |
