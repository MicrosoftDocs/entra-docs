...
1. In the **Tenant URL** field, input your Notion Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Notion. If the connection fails, ensure your Notion account has the required admin permissions and try again.
