...
> [!NOTE]
> [Greenhouse Client support team](https://www.greenhouse.io/contact) recommends configuring Entra ID side application settings for **IDP** initiated mode. Contact Greenshouse Client support team for more details and to get the correct values mentioned below. 
