...
1. In the **Tenant URL** field, input your NordPass Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to NordPass. If the connection fails, ensure your NordPass account has the required admin permissions and try again.
