...
1. In the **Tenant URL** field, input your Gong Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Gong. If the connection fails, ensure your Gong account has the required admin permissions and try again.
