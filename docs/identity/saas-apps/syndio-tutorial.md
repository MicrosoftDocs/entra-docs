---
title: Configure Syndio for Single sign-on with Microsoft Entra ID
...
# Configure Syndio for Single sign-on with Microsoft Entra ID

In this article,  you learn how to integrate Syndio with Microsoft Entra ID. When you integrate Syndio with Microsoft Entra ID, you can:
...
1. **[Configure Syndio SSO](#configure-syndio-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Syndio test user](#create-syndio-test-user)** - to have a counterpart of B.Simon in Syndio that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **Syndio** > **Single sign-on**.
...
1. On the **Basic SAML Configuration** section, enter the values for the following fields:
	...
	> [!NOTE]
	> These values aren't real. Update these values with the actual Sign on URL, Identifier and Reply URL. Contact [Syndio Client support team](mailto:support@synd.io) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section.
...
In this section, a user called Britta Simon is created in Syndio. Syndio supports just-in-time user provisioning, which is enabled by default. There's no action item for you in this section. If a user doesn't already exist in Syndio, a new one is created after authentication.

## Test SSO 

In this section, you test your Microsoft Entra single sign-on configuration with following options. 

* Select **Test this application**, this option redirects to Syndio Sign-on URL where you can initiate the login flow. 

* Go to Syndio Sign-on URL directly and initiate the login flow from there.

* You can use Microsoft My Apps. When you select the Syndio tile in the My Apps, this option redirects to Syndio Sign-on URL. For more information about the My Apps, see [Introduction to the My Apps](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
