...
In this article,  you'll learn how to integrate EAB with Microsoft Entra ID. When you integrate EAB with Microsoft Entra ID, you can:
...
* You can use Microsoft My Apps. When you click the EAB tile in the My Apps, this will redirect to EAB Sign-on URL. For more information about the My Apps, see [Introduction to the My Apps](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
