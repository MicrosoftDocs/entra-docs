...
1. In the **Tenant URL** field, enter your LimbleCMMS Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to LimbleCMMS. If the connection fails, ensure your LimbleCMMS account has the required admin permissions and try again.
