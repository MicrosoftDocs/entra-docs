...
1. In the **Tenant URL** field, input your Xledger Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Xledger. If the connection fails, ensure your Xledger account has the required admin permissions and try again.
