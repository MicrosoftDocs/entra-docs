...
1. In the **Tenant URL** field, input your Gtmhub Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Gtmhub. If the connection fails, ensure your Gtmhub account has the required admin permissions and try again.
