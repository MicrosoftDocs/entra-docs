...
Add HighQ from the Microsoft Entra application gallery to configure single sign-on with HighQ. For more information on how to add application from the gallery, see the [Quickstart: Add application from the gallery](~/identity/enterprise-apps/add-application-portal.md).
...
1. Browse to **Entra ID** > **Enterprise apps** > **HighQ** > **Single sign-on**.
