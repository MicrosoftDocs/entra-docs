...
1. In the **Tenant URL** field, input your Egnyte Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Egnyte. If the connection fails, ensure your Egnyte account has the required admin permissions and try again.
