...
# Configure Kintone for automatic user provisioning with Microsoft Entra ID
...
1. In the **Tenant URL** field, input your Kintone Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Kintone. If the connection fails, ensure your Kintone account has the required admin permissions and try again.
