---
title: Configure edX for Business SAML Integration for Single sign-on with Microsoft Entra ID
...
# Configure edX for Business SAML Integration for Single sign-on with Microsoft Entra ID
