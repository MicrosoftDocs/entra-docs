---
title: Configure Contentsquare SSO for Single sign-on with Microsoft Entra ID
...
# Configure Contentsquare SSO for Single sign-on with Microsoft Entra ID

In this article,  you learn how to integrate Contentsquare SSO with Microsoft Entra ID. When you integrate Contentsquare SSO with Microsoft Entra ID, you can:
...
1. **[Configure Contentsquare SSO SSO](#configure-contentsquare-sso-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Contentsquare SSO test user](#create-contentsquare-sso-test-user)** - to have a counterpart of B.Simon in Contentsquare SSO that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **Contentsquare SSO** > **Single sign-on**.
...
In this section, a user called Britta Simon is created in Contentsquare SSO. Contentsquare SSO supports just-in-time user provisioning, which is enabled by default. There's no action item for you in this section. If a user doesn't already exist in Contentsquare SSO, a new one is created after authentication.

## Test SSO 

In this section, you test your Microsoft Entra single sign-on configuration with following options. 

* Select **Test this application**, this option redirects to Contentsquare SSO Sign-on URL where you can initiate the login flow. 

* Go to Contentsquare SSO Sign-on URL directly and initiate the login flow from there.

* You can use Microsoft My Apps. When you select the Contentsquare SSO tile in the My Apps, this option redirects to Contentsquare SSO Sign-on URL. For more information about the My Apps, see [Introduction to the My Apps](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
