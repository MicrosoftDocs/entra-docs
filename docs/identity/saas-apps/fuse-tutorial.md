---
title: Configure Fuse for Single sign-on with Microsoft Entra ID
...
---
# Configure Fuse for Single sign-on with Microsoft Entra ID
...
1. Browse to **Entra ID** > **Enterprise apps** > **Fuse** > **Single sign-on**.
