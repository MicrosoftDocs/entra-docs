---
title: Configure eFlok for Single sign-on with Microsoft Entra ID
...
# Configure eFlok for Single sign-on with Microsoft Entra ID

In this article,  you learn how to integrate eFlok with Microsoft Entra ID. When you integrate eFlok with Microsoft Entra ID, you can:
...
1. **[Configure eFlok SSO](#configure-eflok-sso)** - to configure the single sign-on settings on application side.
    1. **[Create eFlok test user](#create-eflok-test-user)** - to have a counterpart of B.Simon in eFlok that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **eFlok** > **Single sign-on**.
...
1. Go to **Profile settings** > **Organisation Users** and select **Invite organisation members**.
...
* Select Test this application in Microsoft Entra admin center and you should be automatically signed in to the eFlok for which you set up the SSO.
 
* You can use Microsoft My Apps. When you select the eFlok tile in the My Apps, you should be automatically signed in to the eFlok for which you set up the SSO. For more information about the My Apps, see [Introduction to the My Apps](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
