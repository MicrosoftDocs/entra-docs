---
title: Configure Prolorus for Single sign-on with Microsoft Entra ID
description: Learn how to configure single sign-on between Microsoft Entra ID and Prolorus.

ms.reviewer: jomondi
ms.topic: how-to
ms.date: 06/09/2026
# Customer intent: As an IT administrator, I want to learn how to configure single sign-on between Microsoft Entra ID and Prolorus so that I can control who has access to Prolorus, enable automatic sign-in with Microsoft Entra accounts, and manage my accounts in one central location.
---

# Configure Prolorus for Single sign-on with Microsoft Entra ID

In this article,  you learn how to integrate Prolorus with Microsoft Entra ID. When you integrate Prolorus with Microsoft Entra ID, you can:
...
Prolorus is available in the following [national cloud deployments](/graph/deployments).
...
1. **[Configure Prolorus SSO](#configure-prolorus-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Prolorus test user](#create-prolorus-test-user)** - to have a counterpart of B.Simon in Prolorus that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **Prolorus** > **Single sign-on**.
...
1. On the **Basic SAML Configuration** section, enter the values for the following fields:
	...
	> [!NOTE]
	> These values aren't real. Update these values with the actual Sign on URL, Identifier and Reply URL. Contact the [Prolorus Client support team](mailto:infrastructure@prolorus.com) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section.
...
To configure single sign-on on the **Prolorus** side, you need to send the downloaded **Certificate (Base64)** and appropriate copied URLs from the application configuration to the [Prolorus support team](mailto:infrastructure@prolorus.com). Zipping up the certificate first before sending will ensure it doesn't get blocked by any e-mail systems. They set this setting to have the SAML SSO connection set properly on both sides.
...
* Select **Test this application**, this option redirects to Prolorus Sign-on URL where you can initiate the login flow. 

* Go to Prolorus Sign-on URL directly and initiate the login flow from there.

* You can use Microsoft My Apps. When you select the Prolorus tile in the My Apps, this option redirects to Prolorus Sign-on URL. For more information about the My Apps, see [Introduction to the My Apps](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
