---
title: Configure Verkada Command for Single sign-on with Microsoft Entra ID
...
# Configure Verkada Command for Single sign-on with Microsoft Entra ID

In this article,  you learn how to integrate Verkada Command with Microsoft Entra ID. When you integrate Verkada Command with Microsoft Entra ID, you can:
...
1. **[Configure Verkada Command SSO](#configure-verkada-command-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Verkada Command test user](#create-verkada-command-test-user)** - to have a counterpart of B.Simon in Verkada Command that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **Verkada Command** > **Single sign-on**.
...
1. Select **Set additional URLs** and perform the following step if you wish to configure the application in **SP** initiated mode:
	...
	> [!NOTE]
    > The Sign-on URL value isn't real. Update this value with the actual Sign-on URL. Contact [Verkada Command Client support team](mailto:support@verkada.com) to get this value. You can also refer to the patterns shown in the **Basic SAML Configuration** section.
...
* Select **Test this application**, this option redirects to Verkada Command Sign on URL where you can initiate the login flow.  

* Go to Verkada Command Sign-on URL directly and initiate the login flow from there.

#### IDP initiated:

* Select **Test this application**, and you should be automatically signed in to the Verkada Command for which you set up the SSO. 

You can also use Microsoft My Apps to test the application in any mode. When you select the Verkada Command tile in the My Apps, if configured in SP mode you would be redirected to the application sign on page for initiating the login flow and if configured in IDP mode, you should be automatically signed in to the Verkada Command for which you set up the SSO. For more information about the My Apps, see [Introduction to the My Apps](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
