---
title: Configure Bizagi for Digital Process Automation for Single sign-on with Microsoft Entra ID
...
# Configure Bizagi for Digital Process Automation for Single sign-on with Microsoft Entra ID
...
1. **[Configure Bizagi for Digital Process Automation SSO](#configure-bizagi-for-digital-process-automation-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Bizagi for Digital Process Automation test user](#create-bizagi-for-digital-process-automation-test-user)** - to have a counterpart of B.Simon in Bizagi for Digital Process Automation that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **Bizagi for Digital Process Automation** > **Single sign-on**.
...
1. On the **Set up single sign-on with SAML**page, select the pencil icon for **User Attributes & Claims** to edit the Unique User Identifier.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **Bizagi for Digital Process Automation**.
