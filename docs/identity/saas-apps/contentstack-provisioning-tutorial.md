...
1. In the **Tenant URL** field, enter your Contentstack Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Contentstack. If the connection fails, ensure your Contentstack account has the required admin permissions and try again.
