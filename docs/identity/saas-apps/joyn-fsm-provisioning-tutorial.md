...
1. In the **Tenant URL** field, input your Joyn FSM Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Joyn FSM. If the connection fails, ensure your Joyn FSM account has the required admin permissions and try again.
