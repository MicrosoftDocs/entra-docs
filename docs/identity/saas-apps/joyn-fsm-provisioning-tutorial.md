...
1. In the **Tenant URL** field, enter your Joyn FSM Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Joyn FSM. If the connection fails, ensure your Joyn FSM account has the required admin permissions and try again.
