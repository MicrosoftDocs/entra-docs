---
title: Microsoft Entra SSO integration with QReserve
...
# Microsoft Entra SSO integration with QReserve

In this article,  you'll learn how to integrate QReserve with Microsoft Entra ID. When you integrate QReserve with Microsoft Entra ID, you can:
