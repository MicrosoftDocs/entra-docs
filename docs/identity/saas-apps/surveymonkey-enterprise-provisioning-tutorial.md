...
1. In the **Tenant URL** field, enter your SurveyMonkey Enterprise Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to SurveyMonkey Enterprise. If the connection fails, ensure your SurveyMonkey Enterprise account has the required admin permissions and try again.
