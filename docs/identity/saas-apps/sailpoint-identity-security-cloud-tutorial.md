...
In this article,  you'll learn how to integrate SailPoint Identity Security Cloud with Microsoft Entra ID. When you integrate SailPoint Identity Security Cloud with Microsoft Entra ID, you can:
