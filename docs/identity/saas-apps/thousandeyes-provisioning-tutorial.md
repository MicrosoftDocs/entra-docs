...
1. Under the **Admin Credentials**  section, enter the **OAuth Bearer Token** generated by your ThousandEyes's account (you can find and generate a token under your ThousandEyes account **Profile** section).
