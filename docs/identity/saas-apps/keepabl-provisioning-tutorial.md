...
1. In the **Tenant URL** field, input your Keepabl Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Keepabl. If the connection fails, ensure your Keepabl account has the required admin permissions and try again.
