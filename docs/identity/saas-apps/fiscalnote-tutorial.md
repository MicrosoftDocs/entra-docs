---
title: Microsoft Entra single sign-on (SSO) integration with FiscalNote
...
# Microsoft Entra single sign-on (SSO) integration with FiscalNote

In this article,  you'll learn how to integrate FiscalNote with Microsoft Entra ID. When you integrate FiscalNote with Microsoft Entra ID, you can:
