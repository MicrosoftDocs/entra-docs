...
1. **[Configure SpotDraft SSO](#configure-spotdraft-sso)** - to configure the single sign-on settings on application side.
    1. **[Create SpotDraft test user](#create-spotdraft-test-user)** - to have a counterpart of B.Simon in SpotDraft that is linked to the Microsoft Entra ID representation of user.
