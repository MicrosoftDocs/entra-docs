...
1. In the **Tenant URL** field, input your AlexisHR Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to AlexisHR. If the connection fails, ensure your AlexisHR account has the required admin permissions and try again.
