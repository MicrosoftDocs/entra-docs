---
title: Configure Maptician for Single sign-on with Microsoft Entra ID
...
# Configure Maptician for Single sign-on with Microsoft Entra ID

In this article,  you learn how to integrate Maptician with Microsoft Entra ID. When you integrate Maptician with Microsoft Entra ID, you can:
...
1. **[Configure Maptician SSO](#configure-maptician-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Maptician test user](#create-maptician-test-user)** - to have a counterpart of B.Simon in Maptician that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **Maptician** > **Single sign-on**.
...
1. Select **Set additional URLs** and perform the following step if you wish to configure the application in **SP** initiated mode:
	...
	> [!NOTE]
	> These values aren't real. Update these values with the actual Identifier, Reply URL and Sign-on URL. Contact [Maptician Client support team](mailto:support@maptician.com) to get these values. You can also refer to the patterns shown in the **Basic SAML Configuration** section.
