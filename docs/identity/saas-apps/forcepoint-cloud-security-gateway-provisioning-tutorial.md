...
1. In the **Tenant URL** field, input your Forcepoint Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Forcepoint. If the connection fails, ensure your Forcepoint account has the required admin permissions and try again.
