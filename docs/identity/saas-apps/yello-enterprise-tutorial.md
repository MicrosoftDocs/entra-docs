---
title: Configure Yello Enterprise for Single sign-on with Microsoft Entra ID
...
# Configure Yello Enterprise for Single sign-on with Microsoft Entra ID

In this article,  you learn how to integrate Yello Enterprise with Microsoft Entra ID. When you integrate Yello Enterprise with Microsoft Entra ID, you can:
...
1. **[Configure Yello Enterprise SSO](#configure-yello-enterprise-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Yello Enterprise test user](#create-yello-enterprise-test-user)** - to have a counterpart of B.Simon in Yello Enterprise that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **Yello Enterprise** > **Single sign-on**.
...
1. On the **Basic SAML Configuration** section, enter the values for the following fields:
	...
	> [!NOTE]
	> This value isn't real. Update the value with the actual Identifier. Contact [Yello Enterprise Client support team](mailto:support@yello.co) to get the value. You can also refer to the patterns shown in the **Basic SAML Configuration** section.
...
* Select **Test this application**, and you should be automatically signed in to the Yello Enterprise for which you set up the SSO

* You can use Microsoft My Apps. When you select the Yello Enterprise tile in the My Apps, you should be automatically signed in to the Yello Enterprise for which you set up the SSO. For more information about the My Apps, see [Introduction to the My Apps](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
