...
# Customer intent: As an IT administrator, I want to learn how to configure single sign-on between Microsoft Entra ID and Inkling so that I can control who has access to Inkling, enable automatic sign-in with Microsoft Entra accounts, and manage my accounts in one central location.
---
...
1. In the **Add from the gallery** section, type **Inkling** in the search box.
1. Select **Inkling** from results panel and then add the app. Wait a few seconds while the app is added to your tenant.
