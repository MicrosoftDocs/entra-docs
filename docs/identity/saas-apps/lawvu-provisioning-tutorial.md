...
# Configure LawVu for automatic user provisioning with Microsoft Entra ID
...
1. In the **Tenant URL** field, enter your LawVu Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to LawVu. If the connection fails, ensure your LawVu account has the required admin permissions and try again.
