...
1. In the **Tenant URL** field, input your LawVu Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to LawVu. If the connection fails, ensure your LawVu account has the required admin permissions and try again.
