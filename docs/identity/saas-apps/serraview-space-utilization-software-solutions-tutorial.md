---
title: Configure Serraview Space Utilization Software Solutions for Single sign-on with Microsoft Entra ID
...
# Configure Serraview Space Utilization Software Solutions for Single sign-on with Microsoft Entra ID

In this article,  you learn how to integrate Serraview Space Utilization Software Solutions with Microsoft Entra ID. When you integrate Serraview Space Utilization Software Solutions with Microsoft Entra ID, you can:
...
1. **[Configure Serraview Space Utilization Software Solutions SSO](#configure-serraview-space-utilization-software-solutions-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Serraview Space Utilization Software Solutions test user](#create-serraview-space-utilization-software-solutions-test-user)** - to have a counterpart of B.Simon in Serraview Space Utilization Software Solutions that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **Serraview Space Utilization Software Solutions** > **Single sign-on**.
