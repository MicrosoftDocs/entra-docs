---
title: Configure Chengliye Smart SMS Platform for Single sign-on with Microsoft Entra ID
...
1. Browse to **Entra ID** > **Enterprise apps** > **Chengliye Smart SMS Platform** > **Single sign-on**.
