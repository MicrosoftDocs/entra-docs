...
1. **[Configure Applitools Eyes SSO](#configure-applitools-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Applitools Eyes test user](#create-applitools-test-user)** - to have a counterpart of B.Simon in Applitools Eyes that is linked to the Microsoft Entra ID representation of user.
