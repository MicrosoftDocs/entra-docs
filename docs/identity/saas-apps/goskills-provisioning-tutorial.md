...
## Step 2: Add GoSkills from the Microsoft Entra application gallery
...
## Step 4: Configure automatic user provisioning to GoSkills 
...
1. In the **Admin Credentials** section, enter the **Tenant Url** and then click on Authorize, make sure that you enter your GoSkills account's Admin credentials. Click **Test Connection** to ensure Microsoft Entra ID can connect to GoSkills. If the connection fails, ensure your GoSkills account has Admin permissions and try again.
