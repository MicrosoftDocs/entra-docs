...
1. **[Configure Ocurus SSO](#configure-ocurus-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Ocurus test user](#create-ocurus-test-user)** - to have a counterpart of B.Simon in Ocurus that is linked to the Microsoft Entra ID representation of user.
