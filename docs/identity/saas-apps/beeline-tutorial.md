...
### Send SSO configuration to Beeline Enterprise support team

In this section, you'll gather SSO configuration settings and send them to the [Beeline Enterprise support team](mailto:support@beeline.com).
