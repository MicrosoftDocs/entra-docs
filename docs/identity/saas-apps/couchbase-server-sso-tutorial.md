...
In this article,  you'll learn how to integrate Couchbase Server - SSO with Microsoft Entra ID. When you integrate Couchbase Server - SSO with Microsoft Entra ID, you can:
