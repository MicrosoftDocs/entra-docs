...
> * [Single sign-on](../manage-apps/add-application-portal-setup-oidc-sso.md) to Puzzel (recommended).
...
* Determine what data to [map between Microsoft Entra ID and Puzzel](../app-provisioning/customize-application-attributes.md).
