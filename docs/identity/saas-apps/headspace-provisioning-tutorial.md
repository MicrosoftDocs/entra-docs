...
1. In the **Tenant URL** field, input your Headspace Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Headspace. If the connection fails, ensure your Headspace account has the required admin permissions and try again.
