---
title: Configure Whimsical for Single sign-on with Microsoft Entra ID
...
# Customer intent: As an IT administrator, I want to learn how to configure single sign-on between Microsoft Entra ID and Whimsical so that I can control who has access to Whimsical, enable automatic sign-in with Microsoft Entra accounts, and manage my accounts in one central location.
---

# Configure Whimsical for Single sign-on with Microsoft Entra ID
...
1. **[Configure Whimsical SSO](#configure-whimsical-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Whimsical test user](#create-whimsical-test-user)** - to have a counterpart of B.Simon in Whimsical that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **Whimsical** > **Single sign-on**.
