---
title: Configure MetLife Legal Plans Member App for Single sign-on with Microsoft Entra ID
...
# Configure MetLife Legal Plans Member App for Single sign-on with Microsoft Entra ID
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **MetLife Legal Plans Member App** > **Single sign-on**.
