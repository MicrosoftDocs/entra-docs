...
In this tutorial, you'll learn how to integrate MetLife Legal Plans Member App with Microsoft Entra ID. When you integrate MetLife Legal Plans Member App with Microsoft Entra ID, you can:
...
To integrate Microsoft Entra ID with MetLife Legal Plans Member App, you need:
...
In this section, you'll enable B.Simon to use Microsoft Entra single sign-on by granting access to MetLife Legal Plans Member App.

1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Identity** > **Applications** > **Enterprise applications** > **MetLife Legal Plans Member App**.
