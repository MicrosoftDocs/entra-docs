...
In this tutorial, you'll learn how to integrate DLG Learning Center with Microsoft Entra ID. When you integrate DLG Learning Center with Microsoft Entra ID, you can:
...
1. **[Configure DLG Learning Center SSO](#configure-dlg-learning-center-sso)** - to configure the single sign-on settings on application side.
    1. **[Create DLG Learning Center test user](#create-dlg-learning-center-test-user)** - to have a counterpart of B.Simon in DLG Learning Center that is linked to the Microsoft Entra ID representation of user.
