...
1. In the **Tenant URL** field, input your SAP Litmos Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to SAP Litmos. If the connection fails, ensure your SAP Litmos account has the required admin permissions and try again.
