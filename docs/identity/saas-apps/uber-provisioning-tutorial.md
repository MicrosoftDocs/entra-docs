---
title: Configure Uber for automatic user provisioning with Microsoft Entra ID
...
# Configure Uber for automatic user provisioning with Microsoft Entra ID
...
1. In the **Tenant URL** field, input your Uber Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Uber. If the connection fails, ensure your Uber account has the required admin permissions and try again.
