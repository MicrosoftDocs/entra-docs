...
> [!NOTE]
> If a user has Global Administrator rights in Entra ID, they can sign in through the SSO-endpoint on your GitHub organization without being added as a member of the enterprise application. They will also be able to self-join the organization without having an invite.
