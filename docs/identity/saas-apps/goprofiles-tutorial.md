...
1. On the Basic SAML Configuration section, the application is preconfigured and the necessary URLs are already prepopulated with Microsodt Entra ID. The user needs to save the configuration by clicking the Save button.
