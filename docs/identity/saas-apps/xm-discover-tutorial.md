...
1. **[Configure XM Discover SSO](#configure-xm-discover-sso)** - to configure the single sign-on settings on application side.
    1. **[Create XM Discover test user](#create-xm-discover-test-user)** - to have a counterpart of B.Simon in XM Discover that is linked to the Microsoft Entra ID representation of user.
...
* Click on Test this application in Microsoft Entra admin center and you should be automatically signed in to the Grammarly for which you set up the SSO.
