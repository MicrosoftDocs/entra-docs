---
title: 'Tutorial: Configure Keystone for automatic user provisioning with Microsoft Entra ID'
description: Learn how to automatically provision and de-provision user accounts from Microsoft Entra ID to Keystone.

author: twimmers
writer: twimmers
manager: jeedes
ms.assetid: a848d2f5-8356-4168-a481-10a85e7b9d1b
ms.service: entra-id
