...
1. Under the **Admin Credentials** section, input your Keystone Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Keystone. If the connection fails, ensure your Keystone account has Admin permissions and try again.
