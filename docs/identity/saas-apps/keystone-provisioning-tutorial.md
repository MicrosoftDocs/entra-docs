...
# Configure Keystone for automatic user provisioning with Microsoft Entra ID
...
> * Remove users in Keystone when they don't require access anymore.
...
1. In the **Tenant URL** field, input your Keystone Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Keystone. If the connection fails, ensure your Keystone account has the required admin permissions and try again.
