...
1. In the **Tenant URL** field, input your Funnel Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Funnel. If the connection fails, ensure your Funnel account has the required admin permissions and try again.
