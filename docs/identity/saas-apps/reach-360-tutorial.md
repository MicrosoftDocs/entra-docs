...
1. **[Configure Reach 360 SSO](#configure-reach-360-sso)** - to configure the single sign-on settings on application side.
    1. **[Create Reach 360 test user](#create-reach-360-test-user)** - to have a counterpart of B.Simon in Reach 360 that is linked to the Microsoft Entra ID representation of user.
