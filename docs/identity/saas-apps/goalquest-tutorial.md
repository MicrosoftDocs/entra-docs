---
title: Configure GoalQuest for Single sign-on with Microsoft Entra ID
...
# Configure GoalQuest for Single sign-on with Microsoft Entra ID

In this article,  you learn how to integrate GoalQuest with Microsoft Entra ID. When you integrate GoalQuest with Microsoft Entra ID, you can:
...
1. **[Configure GoalQuest SSO](#configure-goalquest-sso)** - to configure the single sign-on settings on application side.
    1. **[Create GoalQuest test user](#create-goalquest-test-user)** - to have a counterpart of B.Simon in GoalQuest that's linked to the Microsoft Entra representation of user.
...
1. Sign in to the [Microsoft Entra admin center](https://entra.microsoft.com) as at least a [Cloud Application Administrator](~/identity/role-based-access-control/permissions-reference.md#cloud-application-administrator).
1. Browse to **Entra ID** > **Enterprise apps** > **GoalQuest** > **Single sign-on**.
...
* Select **Test this application**, and you should be automatically signed in to the GoalQuest for which you set up the SSO.

* You can use Microsoft My Apps. When you select the GoalQuest tile in the My Apps, you should be automatically signed in to the GoalQuest for which you set up the SSO. For more information, see [Microsoft Entra My Apps](/azure/active-directory/manage-apps/end-user-experiences#azure-ad-my-apps).
