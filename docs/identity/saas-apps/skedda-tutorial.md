---
title: Microsoft Entra single sign-on (SSO) integration with Skedda
...
# Microsoft Entra single sign-on (SSO) integration with Skedda

In this article,  you'll learn how to integrate Skedda with Microsoft Entra ID. When you integrate Skedda with Microsoft Entra ID, you can:
