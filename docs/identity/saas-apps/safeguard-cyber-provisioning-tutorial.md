...
1. In the **Tenant URL** field, enter your SafeGuard Cyber Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to SafeGuard Cyber. If the connection fails, ensure your SafeGuard Cyber account has the required admin permissions and try again.
