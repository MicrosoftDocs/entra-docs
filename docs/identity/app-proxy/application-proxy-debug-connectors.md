...
|10 | If issues persist, target specific flow issues, review app and single sign-on (SSO) debugging flows | Use the [Debug application proxy application issues](application-proxy-debug-apps.md) troubleshooting flow. |
