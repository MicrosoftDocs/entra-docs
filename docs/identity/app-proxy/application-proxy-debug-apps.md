...
First, check the connector. Learn how in [Troubleshoot private network connectors](~/global-secure-access/troubleshoot-connectors.md).
...
- [Understand private network connectors](~/global-secure-access/concept-connectors.md).
