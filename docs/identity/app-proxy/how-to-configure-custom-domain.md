...
You upload a certificate for an application and it's automatically applied to **new** apps configured to use it. You need to upload the certificate again for existing apps in your tenant.
