...
Once a certificate is uploaded for an application, it's automatically applied to **new** apps configured that use the same certificate. You need to reupload the certificate for existing apps in your tenant.
