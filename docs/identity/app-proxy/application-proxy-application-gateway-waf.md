...
![Application Gateway backend settings configuration page showing request routing parameters.](./media/application-proxy-waf/application-gateway-backend-settings.png)
 ...
 ![Application Gateway routing rule configuration page showing listener selection step.](./media/application-proxy-waf/application-gateway-add-rule-1.png)
 ![Application Gateway routing rule configuration page showing backend pool and backend settings selection.](./media/application-proxy-waf/application-gateway-add-rule-2.png)
...
![Microsoft Entra ID sign-in page prompting user for authentication.](./media/application-proxy-waf/sign-in-2.png)
![Browser showing successful application access after authentication.](./media/application-proxy-waf/application-gateway-response.png)
