...
If you can reach the application from that machine, to look for issues or errors with the connector itself. You can see some common errors in [Troubleshoot connectors](../../global-secure-access/troubleshoot-connectors.md). You can also look directly at the connector logs to identify any errors. Many of our error messages be able to share more specific recommendations for fixes. To learn how to view the logs, see [Microsoft Entra private network connector](../../global-secure-access/concept-connectors.md).
