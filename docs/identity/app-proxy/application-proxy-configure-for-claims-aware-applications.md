...
description: How to publish on-premises ASP.NET applications that accept Active Directory Federated Services claims for secure remote access by your users.
author: kenwith
...
You can configure Active Directory Federated Services for claims-aware apps in one of two ways. The first is by using custom domains. The second is with WS-Federation. 
...
1. Open Active Directory Federated Services management.
