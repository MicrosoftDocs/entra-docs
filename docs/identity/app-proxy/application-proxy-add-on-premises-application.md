...
- An understanding of application management in Microsoft Entra. For more information, see [View enterprise applications in Microsoft Entra](~/identity/enterprise-apps/view-applications-portal.md).
- An understanding of single sign-on (SSO). For more information, see [Understand single sign-on](~/identity/enterprise-apps/what-is-single-sign-on.md).
...
1. Under **Add assignment**, select **Users and groups**. The **Users and groups** section appears.
...
1. At the top of the page, select **Test Application** to run a test on the application and check for any configuration issues.
1. First, launch the application to test signing in to it. Then download the diagnostic report to review the resolution guidance for any detected issues.
...
Custom domains let you specify the domain of your external URLs. To use custom domains, you need to upload the certificate for that domain. For information on using custom domains and certificates, see [Working with custom domains in Microsoft Entra application proxy](how-to-configure-custom-domain.md).
...
- [Plan a Microsoft Entra application proxy deployment](~/identity/app-proxy/conceptual-deployment-plan.md)
- [Security considerations for accessing apps remotely with Microsoft Entra application proxy](~/identity/app-proxy/application-proxy-security.md)
