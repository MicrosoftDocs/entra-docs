...
<sup>8</sup> **Microsoft Entra join support** is available with [Azure Virtual Desktop](https://learn.microsoft.com/azure/virtual-desktop/), [Windows 365](https://www.microsoft.com/windows-365) and [Amazon WorkSpaces](https://docs.aws.amazon.com/workspaces/latest/adminguide/launch-workspaces-tutorials.html#launch-entra-id). For any support related queries with mazon WorkSpaces, contact [Amazon support](https://aws.amazon.com/contact-us/) directly.
