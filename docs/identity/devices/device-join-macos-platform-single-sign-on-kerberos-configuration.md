...
You should configure separate Kerberos SSO MDM profiles if you plan to use both Microsoft Entra ID Cloud Kerberos and on-premises Active Directory realms. If you dont plan to use Cloud Kerberos TGT, then you need to configure only the On prem Kerberos SSO profile.
