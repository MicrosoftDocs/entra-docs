...
- **User account type**: Only standard Microsoft Entra user accounts from the same tenant as the azure windows virtual machine are supported. [Guest accounts (B2B users)](../../external-id/what-is-b2b.md) cannot be used for authentication.
