...
The AADLoginForWindows extension is intended to be installed only on Arc-enabled Windows Servers with Windows Server 2025 or later operating systems. Ensure that your version of Windows Server is supported. If it isn't supported, uninstall the extension.
