...
1. Set the expiration interval. Select a preset value or enter a custom value over 31 days.

1. Provide an email address where expiration notifications should be sent when a group has no owner.

1. For this quickstart, set **Enable expiration for these Microsoft 365 groups** to **All**.

1. Select **Save** to save the expiration settings when you're done.
