---
title: PowerShell sample - Resume specific critical groups and administrative units with dynamic membership
description: PowerShell sample that resumes dynamic membership processing for specific critical groups and administrative units in your Microsoft Entra tenant after pausing.
ms.topic: sample
ms.date: 06/11/2026
...
# Resume specific critical groups and administrative units with dynamic membership
