...
## Prerequisites
To evaluate the dynamic group rule membership feature, the administrator must have one of the following roles assigned directly: Global Administrator, Groups Administrator, or Intune Administrator.
