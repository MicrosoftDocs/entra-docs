...
In this document, when we say 'Synced user', we mean users synced from on-premises. The administrator is unable to specify the UPN for these users because they are managed on-premises. 
