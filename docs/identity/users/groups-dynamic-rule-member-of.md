...
>[!WARNING]
>This is a preview feature and is not intended for production use. The use of this feature comes with limitations that can impact dynamic group processing in the tenant. We recommend you review the [Preview limitations](#preview-limitations) section before using this feature.
...
- This preview should only be used in test environments as it can impact dynamic group processing in the tenant. We are working on addressing these limitations and will provide updates when they are available.
