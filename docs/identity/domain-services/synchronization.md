...
> [!NOTE]
> Enhanced support for synchronizing the Security Account Manager account name (sAMAccountName) with Microsoft Entra Domain Services is now in [Public Preview](/entra/identity/domain-services/sam-account-name/sam-account-name).
