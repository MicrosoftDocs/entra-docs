...
| Videos| [What is user provisioning in Entra ID?](https://youtu.be/_ZjARPpI6NI) <br> [How to deploy user provisioning in Entra ID?](https://youtu.be/pKzyts6kfrw) <br> [Integrating Salesforce with Microsoft Entra ID: How to automate User Provisioning](https://youtu.be/MAy8s5WSe3A) |
