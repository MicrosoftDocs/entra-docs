...
For applications with no provisioning interface, consider using the [automated ServiceNow ticket creation to assign a ticket to an application owner](~/id-governance/entitlement-management-ticketed-provisioning.md) when a user is assigned or loses access.
...
* [Entitlement management](~/id-governance/entitlement-management-overview.md).  <!-- EXPAND -->
...
* callouts to custom Azure LogicApps from [entitlement management](~/id-governance/entitlement-management-logic-apps-integration.md) and [lifecycle workflows](~/id-governance/lifecycle-workflow-extensibility.md)
