...
If you have identified a need for a Microsoft Entra ID governance capability, such as Microsoft Entra entitlement management or Microsoft Entra lifecycle workflows, then deploy those features before bringing in workers as users into Microsoft Entra ID.
