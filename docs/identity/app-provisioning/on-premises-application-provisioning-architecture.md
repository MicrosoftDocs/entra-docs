...
## High Availability
The following information is provided for high availablity / failover scenarios.
...
For on-prem apps using the SCIM connector: The recommendation is having 2 active agents per application.
 ...
 :::image type="content" source="\media\on-premises-application-provisioning-architecture\high-availability-2.png" alt-text="Diagram of high availability with SCIM connector." lightbox="\media\on-premises-application-provisioning-architecture\high-availability-1.png":::
