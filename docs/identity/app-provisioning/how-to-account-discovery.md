...
- See [Supported applications](#supported-applications) for applications that support Account Discovery. Account Discovery isn't supported for the following applications:
  - Workday
  - SAP SuccessFactors
