...
- One of the following roles (or a role with equivalent permissions): [Security administrator](/identity/role-based-access-control/permissions-reference.md#security-administrator), [Security reader](/identity/role-based-access-control/permissions-reference.md#security-reader), or [Reports reader](/identity/role-based-access-control/permissions-reference.md#reports-reader).
