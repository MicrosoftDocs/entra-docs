...
> [!NOTE]
> Graph API calls are subject to throttling. Please review the [limits](/graph/throttling-limits#identity-and-access-service-limits) to ensure your usage is within appropriate limits.
