---
title: Block Agent Identities with Conditional Access
description: Discover how to configure a Conditional Access policy to block agent identities in Microsoft Entra. Ensure secure access with detailed guidance.
