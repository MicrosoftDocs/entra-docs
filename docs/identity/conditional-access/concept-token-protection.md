...
> [!NOTE]
> We may interchange sign in tokens and refresh tokens in this content. If you want to provide protection for M365 Access Tokens and application sesssion cookies, consider trying [compliant network check enforcement](/entra/global-secure-access/how-to-compliant-network).
