...
:::image type="content" source="media/deployment-guide-token-protection-windows/token-protection-required-error-message.png" alt-text="Screenshot of the error message when a token protection policy blocks access.":::
