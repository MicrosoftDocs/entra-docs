...
- Admins must review their Conditional Access policies to ensure that they do not have any policies that aren't supported by CAE yet. Refer to the [CAE-supported CA policies](/entra/identity/conditional-access/concept-continuous-access-evaluation#supported-location-policies) for more details.
