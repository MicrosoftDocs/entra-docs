...
|Multi-factor crypto hardware <br> (something you have + something you know/are) | Multi-factor hardware protected certificate <br> Windows Hello for Business with hardware TPM <br> FIDO 2 security key <br> Platform SSO for macOS (Secure Enclave) <br> Passkey in Microsoft Authenticator|
