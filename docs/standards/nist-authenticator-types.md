...
|Multi-factor crypto hardware <br> (something you have + something you know/are) |Hardware protected certificate (smartcard/security key/TPM) <br> Windows Hello for Business with hardware TPM <br> FIDO 2 security key <br> Platform credentials for macOS (Secure Enclave) <br> Passkey in Microsoft Authenticator|
